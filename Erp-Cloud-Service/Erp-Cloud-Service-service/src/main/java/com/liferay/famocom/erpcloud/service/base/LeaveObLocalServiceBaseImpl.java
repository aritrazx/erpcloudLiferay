...
import com.liferay.famocom.erpcloud.service.LeaveObLocalService;
...
/**
 * Provides the base implementation for the leave ob local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.LeaveObLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class LeaveObLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LeaveObLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.LeaveObLocalServiceUtil} to access the leave ob local service.
	 */
	...
	@Override
	public LeaveOb addLeaveOb(LeaveOb leaveOb) {
		leaveOb.setNew(true);

		return leaveObPersistence.update(leaveOb);
	}
	...
	public LeaveOb createLeaveOb(long leaveobId) {
		return leaveObPersistence.create(leaveobId);
	}
	...
	@Override
	public LeaveOb deleteLeaveOb(long leaveobId) throws PortalException {
		return leaveObPersistence.remove(leaveobId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveOb deleteLeaveOb(LeaveOb leaveOb) {
		return leaveObPersistence.remove(leaveOb);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveOb.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return leaveObPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return leaveObPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return leaveObPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return leaveObPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return leaveObPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public LeaveOb fetchLeaveOb(long leaveobId) {
		return leaveObPersistence.fetchByPrimaryKey(leaveobId);
	}
	 ...
	 */
	@Override
	public LeaveOb getLeaveOb(long leaveobId) throws PortalException {
		return leaveObPersistence.findByPrimaryKey(leaveobId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(leaveObLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LeaveOb.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("leaveobId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(leaveObLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LeaveOb.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("leaveobId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return leaveObLocalService.deleteLeaveOb((LeaveOb)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return leaveObPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveOb> getLeaveObs(int start, int end) {
		return leaveObPersistence.findAll(start, end);
	}
	...
	public int getLeaveObsCount() {
		return leaveObPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveOb updateLeaveOb(LeaveOb leaveOb) {
		return leaveObPersistence.update(leaveOb);
	}
	 ...
	 */
	public LeaveObLocalService getLeaveObLocalService() {
	 ...
	 */
	public void setLeaveObLocalService(LeaveObLocalService leaveObLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.LeaveOb",
			leaveObLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.LeaveOb");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveObLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = leaveObPersistence.getDataSource();
	...
	@BeanReference(type = LeaveObLocalService.class)
	protected LeaveObLocalService leaveObLocalService;
