package com.liferay.famocom.erpcloud.emailtemp.util;
...
public class MyComparator extends OrderByComparator {
	...
	public int compare(Object obj1, Object obj2) {
		...
		Object value2 = null;
		try {
			if ("templateName".equalsIgnoreCase(sortByCol) && obj1 instanceof EmailTemplate) {
				EmailTemplate ts1 = (EmailTemplate) obj1;
				EmailTemplate ts2 = (EmailTemplate) obj2;
				value1 = ts1.getTemplateName();
				value2 = ts2.getTemplateName();
			} else if("emailFor".equalsIgnoreCase(sortByCol) && obj1 instanceof EmailTemplate) {
				EmailTemplate ts1 = (EmailTemplate) obj1;
				EmailTemplate ts2 = (EmailTemplate) obj2;
				value1 = ts1.getEmailFor();
				value2 = ts2.getEmailFor();
			}
			else {
				try {
