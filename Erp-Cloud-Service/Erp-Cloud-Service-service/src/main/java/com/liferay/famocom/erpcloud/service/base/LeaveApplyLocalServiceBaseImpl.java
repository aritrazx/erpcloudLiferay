...
import com.liferay.famocom.erpcloud.service.LeaveApplyLocalService;
...
/**
 * Provides the base implementation for the leave apply local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.LeaveApplyLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.LeaveApplyLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.LeaveApplyLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class LeaveApplyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LeaveApplyLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.LeaveApplyLocalServiceUtil} to access the leave apply local service.
	 */
	...
	@Override
	public LeaveApply addLeaveApply(LeaveApply leaveApply) {
		leaveApply.setNew(true);

		return leaveApplyPersistence.update(leaveApply);
	}
	...
	public LeaveApply createLeaveApply(long leaveApplyId) {
		return leaveApplyPersistence.create(leaveApplyId);
	}
	...
	@Override
	public LeaveApply deleteLeaveApply(long leaveApplyId)
		throws PortalException {
		return leaveApplyPersistence.remove(leaveApplyId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveApply deleteLeaveApply(LeaveApply leaveApply) {
		return leaveApplyPersistence.remove(leaveApply);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveApply.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return leaveApplyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return leaveApplyPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return leaveApplyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LeaveApply fetchLeaveApply(long leaveApplyId) {
		return leaveApplyPersistence.fetchByPrimaryKey(leaveApplyId);
	}
	 ...
	 */
	@Override
	public LeaveApply getLeaveApply(long leaveApplyId)
		throws PortalException {
		return leaveApplyPersistence.findByPrimaryKey(leaveApplyId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(leaveApplyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LeaveApply.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("leaveApplyId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(leaveApplyLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LeaveApply.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return leaveApplyLocalService.deleteLeaveApply((LeaveApply)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return leaveApplyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveApply> getLeaveApplies(int start, int end) {
		return leaveApplyPersistence.findAll(start, end);
	}
	...
	public int getLeaveAppliesCount() {
		return leaveApplyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveApply updateLeaveApply(LeaveApply leaveApply) {
		return leaveApplyPersistence.update(leaveApply);
	}
	 ...
	 */
	public LeaveApplyLocalService getLeaveApplyLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.LeaveApply",
			leaveApplyLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.LeaveApply");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveApplyLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = leaveApplyPersistence.getDataSource();
	...
	@BeanReference(type = LeaveApplyLocalService.class)
	protected LeaveApplyLocalService leaveApplyLocalService;
