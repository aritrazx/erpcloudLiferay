...
import com.liferay.famocom.erpcloud.service.CompanyPolicyLocalService;
...
/**
 * Provides the base implementation for the company policy local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.CompanyPolicyLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.CompanyPolicyLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.CompanyPolicyLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CompanyPolicyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CompanyPolicyLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.CompanyPolicyLocalServiceUtil} to access the company policy local service.
	 */
	...
	@Override
	public CompanyPolicy addCompanyPolicy(CompanyPolicy companyPolicy) {
		companyPolicy.setNew(true);

		return companyPolicyPersistence.update(companyPolicy);
	}
	...
	public CompanyPolicy createCompanyPolicy(long companyPolicyId) {
		return companyPolicyPersistence.create(companyPolicyId);
	}
	...
	@Override
	public CompanyPolicy deleteCompanyPolicy(long companyPolicyId)
		throws PortalException {
		return companyPolicyPersistence.remove(companyPolicyId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CompanyPolicy deleteCompanyPolicy(CompanyPolicy companyPolicy) {
		return companyPolicyPersistence.remove(companyPolicy);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CompanyPolicy.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return companyPolicyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return companyPolicyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CompanyPolicy fetchCompanyPolicy(long companyPolicyId) {
		return companyPolicyPersistence.fetchByPrimaryKey(companyPolicyId);
	}
	 ...
	 */
	@Override
	public CompanyPolicy getCompanyPolicy(long companyPolicyId)
		throws PortalException {
		return companyPolicyPersistence.findByPrimaryKey(companyPolicyId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(companyPolicyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CompanyPolicy.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("companyPolicyId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(companyPolicyLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CompanyPolicy.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return companyPolicyLocalService.deleteCompanyPolicy((CompanyPolicy)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return companyPolicyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CompanyPolicy> getCompanyPolicies(int start, int end) {
		return companyPolicyPersistence.findAll(start, end);
	}
	...
	public int getCompanyPoliciesCount() {
		return companyPolicyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CompanyPolicy updateCompanyPolicy(CompanyPolicy companyPolicy) {
		return companyPolicyPersistence.update(companyPolicy);
	}
	 ...
	 */
	public CompanyPolicyLocalService getCompanyPolicyLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.CompanyPolicy",
			companyPolicyLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.CompanyPolicy");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanyPolicyLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = companyPolicyPersistence.getDataSource();
	...
	@BeanReference(type = CompanyPolicyLocalService.class)
	protected CompanyPolicyLocalService companyPolicyLocalService;
