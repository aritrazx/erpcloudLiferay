...
import com.liferay.famocom.erpcloud.service.LeaveApplyDtlLocalService;
...
/**
 * Provides the base implementation for the leave apply dtl local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.LeaveApplyDtlLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class LeaveApplyDtlLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LeaveApplyDtlLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.LeaveApplyDtlLocalServiceUtil} to access the leave apply dtl local service.
	 */
	...
	public LeaveApplyDtl addLeaveApplyDtl(LeaveApplyDtl leaveApplyDtl) {
		...
		return leaveApplyDtlPersistence.update(leaveApplyDtl);
	}
	...
	public LeaveApplyDtl createLeaveApplyDtl(long leaveApplyDtlId) {
		return leaveApplyDtlPersistence.create(leaveApplyDtlId);
	}
	...
	public LeaveApplyDtl deleteLeaveApplyDtl(long leaveApplyDtlId)
		...
		return leaveApplyDtlPersistence.remove(leaveApplyDtlId);
	}
	...
	public LeaveApplyDtl deleteLeaveApplyDtl(LeaveApplyDtl leaveApplyDtl) {
		return leaveApplyDtlPersistence.remove(leaveApplyDtl);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveApplyDtl.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return leaveApplyDtlPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return leaveApplyDtlPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public LeaveApplyDtl fetchLeaveApplyDtl(long leaveApplyDtlId) {
		return leaveApplyDtlPersistence.fetchByPrimaryKey(leaveApplyDtlId);
	}
	...
	public LeaveApplyDtl getLeaveApplyDtl(long leaveApplyDtlId)
		throws PortalException {
		return leaveApplyDtlPersistence.findByPrimaryKey(leaveApplyDtlId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(leaveApplyDtlLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LeaveApplyDtl.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("leaveApplyDtlId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(leaveApplyDtlLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LeaveApplyDtl.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return leaveApplyDtlLocalService.deleteLeaveApplyDtl((LeaveApplyDtl)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return leaveApplyDtlPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LeaveApplyDtl> getLeaveApplyDtls(int start, int end) {
		return leaveApplyDtlPersistence.findAll(start, end);
	}
	...
	public int getLeaveApplyDtlsCount() {
		return leaveApplyDtlPersistence.countAll();
	}
	 ...
	 */
	public LeaveApplyDtlLocalService getLeaveApplyDtlLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.LeaveApplyDtl",
			leaveApplyDtlLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.LeaveApplyDtl");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveApplyDtlLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = leaveApplyDtlPersistence.getDataSource();
	...
	@BeanReference(type = LeaveApplyDtlLocalService.class)
	protected LeaveApplyDtlLocalService leaveApplyDtlLocalService;
