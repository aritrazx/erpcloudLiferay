...
/**
 * The persistence utility for the billing table service. This utility wraps {@link com.liferay.famocom.erpcloud.service.persistence.impl.BillingTablePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class BillingTableUtil {
	 ...
	 */
	public static void clearCache(BillingTable billingTable) {
		getPersistence().clearCache(billingTable);
	}
	 ...
	 */
	public static List<BillingTable> findWithDynamicQuery(
	 ...
	 */
	public static BillingTable update(BillingTable billingTable) {
		return getPersistence().update(billingTable);
	}
	...
	public static BillingTable update(BillingTable billingTable,
		...
		return getPersistence().update(billingTable, serviceContext);
	}
	...
	*/
	public static void cacheResult(BillingTable billingTable) {
		getPersistence().cacheResult(billingTable);
	}
	...
	*/
	public static void cacheResult(List<BillingTable> billingTables) {
		getPersistence().cacheResult(billingTables);
	}
	...
	*/
	public static BillingTable create(long billingId) {
	...
	*/
	public static BillingTable remove(long billingId)
		throws com.liferay.famocom.erpcloud.exception.NoSuchBillingTableException {
		return getPersistence().remove(billingId);
	}

	public static BillingTable updateImpl(BillingTable billingTable) {
		return getPersistence().updateImpl(billingTable);
	}
	...
	* @throws NoSuchBillingTableException if a billing table with the primary key could not be found
	*/
	public static BillingTable findByPrimaryKey(long billingId)
		throws com.liferay.famocom.erpcloud.exception.NoSuchBillingTableException {
	...
	*/
	public static BillingTable fetchByPrimaryKey(long billingId) {
		return getPersistence().fetchByPrimaryKey(billingId);
	}

	public static java.util.Map<java.io.Serializable, BillingTable> fetchByPrimaryKeys(
	...
	*/
	public static List<BillingTable> findAll() {
	...
	*/
	public static List<BillingTable> findAll(int start, int end) {
	...
	*/
	...
	public static BillingTablePersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<BillingTablePersistence, BillingTablePersistence> _serviceTracker =
		ServiceTrackerFactory.open(BillingTablePersistence.class);
}