...
/**
 * Provides the base implementation for the sal details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.SalDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class SalDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SalDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.SalDetailsLocalServiceUtil} to access the sal details local service.
	 */
	...
	public SalDetails addSalDetails(SalDetails salDetails) {
		...
		return salDetailsPersistence.update(salDetails);
	}
	...
	public SalDetails createSalDetails(long SalDetailsId) {
		return salDetailsPersistence.create(SalDetailsId);
	}
	...
	public SalDetails deleteSalDetails(long SalDetailsId)
		...
		return salDetailsPersistence.remove(SalDetailsId);
	}
	...
	public SalDetails deleteSalDetails(SalDetails salDetails) {
		return salDetailsPersistence.remove(salDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SalDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return salDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return salDetailsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return salDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public SalDetails fetchSalDetails(long SalDetailsId) {
		return salDetailsPersistence.fetchByPrimaryKey(SalDetailsId);
	}
	...
	public SalDetails getSalDetails(long SalDetailsId)
		throws PortalException {
		return salDetailsPersistence.findByPrimaryKey(SalDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(salDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SalDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("SalDetailsId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(salDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SalDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return salDetailsLocalService.deleteSalDetails((SalDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return salDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SalDetails> getSalDetailses(int start, int end) {
		return salDetailsPersistence.findAll(start, end);
	}
	...
	public int getSalDetailsesCount() {
		return salDetailsPersistence.countAll();
	}
	 ...
	 */
	public SalDetailsLocalService getSalDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.SalDetails",
			salDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.SalDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return SalDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = salDetailsPersistence.getDataSource();
	...
	@BeanReference(type = SalDetailsLocalService.class)
	protected SalDetailsLocalService salDetailsLocalService;
