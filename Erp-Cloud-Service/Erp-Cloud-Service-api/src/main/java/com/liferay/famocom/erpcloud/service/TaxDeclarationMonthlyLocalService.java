...
/**
 * Provides the local service interface for TaxDeclarationMonthly. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see TaxDeclarationMonthlyLocalServiceUtil
...
public interface TaxDeclarationMonthlyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TaxDeclarationMonthlyLocalServiceUtil} to access the tax declaration monthly local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.TaxDeclarationMonthlyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<TaxDeclarationMonthly> findTaxDeclarationMonthlyByEmployeeIdAndMonthYears(
		long employeeId, long[] monthYear) throws SystemException;

	public TaxDeclarationMonthly findTaxDeclarationMonthlyByMonthYearAndEmployeeId(
		long employeeId, long monthYear)
		throws SystemException, NoSuchTaxDeclarationMonthlyException;
