...
@Component(immediate = true, property = {
		"resource.name=" + TeamMemberModelPermission.RESOURCE_NAME }, service = ResourcePermissionChecker.class)

public class TeamMemberModelPermission extends BaseResourcePermissionChecker {
