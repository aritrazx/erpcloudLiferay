...
import com.liferay.famocom.erpcloud.service.BankMasterLocalService;
...
/**
 * Provides the base implementation for the bank master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.BankMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.BankMasterLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.BankMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class BankMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BankMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.BankMasterLocalServiceUtil} to access the bank master local service.
	 */
	...
	public BankMaster addBankMaster(BankMaster bankMaster) {
		...
		return bankMasterPersistence.update(bankMaster);
	}
	...
	public BankMaster createBankMaster(long bankId) {
		return bankMasterPersistence.create(bankId);
	}
	...
	@Override
	public BankMaster deleteBankMaster(long bankId) throws PortalException {
		return bankMasterPersistence.remove(bankId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BankMaster deleteBankMaster(BankMaster bankMaster) {
		return bankMasterPersistence.remove(bankMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BankMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return bankMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return bankMasterPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return bankMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BankMaster fetchBankMaster(long bankId) {
		return bankMasterPersistence.fetchByPrimaryKey(bankId);
	}
	 ...
	 */
	@Override
	public BankMaster getBankMaster(long bankId) throws PortalException {
		return bankMasterPersistence.findByPrimaryKey(bankId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(bankMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BankMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(bankMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BankMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return bankMasterLocalService.deleteBankMaster((BankMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return bankMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BankMaster> getBankMasters(int start, int end) {
		return bankMasterPersistence.findAll(start, end);
	}
	...
	public int getBankMastersCount() {
		return bankMasterPersistence.countAll();
	}
	 ...
	 */
	public BankMasterLocalService getBankMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.BankMaster",
			bankMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.BankMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return BankMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = bankMasterPersistence.getDataSource();
	...
	@BeanReference(type = BankMasterLocalService.class)
	protected BankMasterLocalService bankMasterLocalService;
