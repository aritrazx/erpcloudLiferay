...
/**
 * Provides the base implementation for the candidate apply local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.CandidateApplyLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.CandidateApplyLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.CandidateApplyLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CandidateApplyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CandidateApplyLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.CandidateApplyLocalServiceUtil} to access the candidate apply local service.
	 */
	...
	@Override
	public CandidateApply addCandidateApply(CandidateApply candidateApply) {
		candidateApply.setNew(true);

		return candidateApplyPersistence.update(candidateApply);
	}
	...
	public CandidateApply createCandidateApply(long applyCandidateId) {
		return candidateApplyPersistence.create(applyCandidateId);
	}
	...
	@Override
	public CandidateApply deleteCandidateApply(long applyCandidateId)
		throws PortalException {
		return candidateApplyPersistence.remove(applyCandidateId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CandidateApply deleteCandidateApply(CandidateApply candidateApply) {
		return candidateApplyPersistence.remove(candidateApply);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CandidateApply.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return candidateApplyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return candidateApplyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CandidateApply fetchCandidateApply(long applyCandidateId) {
		return candidateApplyPersistence.fetchByPrimaryKey(applyCandidateId);
	}
	 ...
	 */
	@Override
	public CandidateApply getCandidateApply(long applyCandidateId)
		throws PortalException {
		return candidateApplyPersistence.findByPrimaryKey(applyCandidateId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(candidateApplyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CandidateApply.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("applyCandidateId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(candidateApplyLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CandidateApply.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return candidateApplyLocalService.deleteCandidateApply((CandidateApply)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return candidateApplyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CandidateApply> getCandidateApplies(int start, int end) {
		return candidateApplyPersistence.findAll(start, end);
	}
	...
	public int getCandidateAppliesCount() {
		return candidateApplyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CandidateApply updateCandidateApply(CandidateApply candidateApply) {
		return candidateApplyPersistence.update(candidateApply);
	}
	 ...
	 */
	public CandidateApplyLocalService getCandidateApplyLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.CandidateApply",
			candidateApplyLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.CandidateApply");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CandidateApplyLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = candidateApplyPersistence.getDataSource();
	...
	@BeanReference(type = CandidateApplyLocalService.class)
	protected CandidateApplyLocalService candidateApplyLocalService;
