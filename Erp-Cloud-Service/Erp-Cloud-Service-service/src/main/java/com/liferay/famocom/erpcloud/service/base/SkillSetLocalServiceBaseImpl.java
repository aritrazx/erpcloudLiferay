...
import com.liferay.famocom.erpcloud.service.SkillSetLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.SkillSetLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.SkillSetLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.SkillSetLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class SkillSetLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SkillSetLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.SkillSetLocalServiceUtil} to access the skill set local service.
	 */
	...
	public SkillSet createSkillSet(long SkillId) {
		return skillSetPersistence.create(SkillId);
	}
	...
	@Override
	public SkillSet deleteSkillSet(long SkillId) throws PortalException {
		return skillSetPersistence.remove(SkillId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SkillSet.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return skillSetPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return skillSetPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	@Override
	public SkillSet fetchSkillSet(long SkillId) {
		return skillSetPersistence.fetchByPrimaryKey(SkillId);
	}
	 ...
	 */
	@Override
	public SkillSet getSkillSet(long SkillId) throws PortalException {
		return skillSetPersistence.findByPrimaryKey(SkillId);
	}
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(skillSetLocalService);
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.SkillSet",
			skillSetLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.SkillSet");
	}
