package com.liferay.famocom.erpcloud.projectstatus.util;
...
public class MyComparator extends OrderByComparator {
	...
	public int compare(Object obj1, Object obj2) {
		...
		Object value2 = null;
		try {
			if("statusName".equalsIgnoreCase(sortByCol) && obj1 instanceof ProjectStatus) {
				ProjectStatus ps1 = (ProjectStatus) obj1;
				ProjectStatus ps2 = (ProjectStatus) obj2;
				value1 = ps1.getStatusName();
				value2 = ps2.getStatusName();
			} else {
				try {
	...
	private GoalMaster gm1;
	private GoalMaster gm2;	
