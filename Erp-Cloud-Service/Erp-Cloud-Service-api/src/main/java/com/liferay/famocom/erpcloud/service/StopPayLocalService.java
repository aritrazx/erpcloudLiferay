...
/**
 * Provides the local service interface for StopPay. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see StopPayLocalServiceUtil
...
public interface StopPayLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StopPayLocalServiceUtil} to access the stop pay local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.StopPayLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<StopPay> findStopPayByEmployeeId(long employeeId)
		throws SystemException;

	public StopPay findStopPayByEmployeeIdAndMonthYear(long employeeId,
		long monthYear) throws NoSuchStopPayException;

	public List<StopPay> findStopPayByMonthYear(long monthYear)
		throws SystemException;

	public List<StopPay> findStopPayByMonthYearAndStatus(long monthYear,
		long status) throws NoSuchStopPayException;
