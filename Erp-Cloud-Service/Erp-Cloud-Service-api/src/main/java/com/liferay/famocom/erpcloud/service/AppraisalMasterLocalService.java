...
/**
 * Provides the local service interface for AppraisalMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see AppraisalMasterLocalServiceUtil
...
public interface AppraisalMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AppraisalMasterLocalServiceUtil} to access the appraisal master local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.AppraisalMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AppraisalMaster findBySettingIdAndEmployeeId(
		long appraisalSettingId, long employeeId) throws SystemException;

	public AppraisalMaster findBySettingIdAndEmployeeIds(
		long appraisalSettingId, long employeeId) throws SystemException;

	public List<AppraisalMaster> findBySettingIdAndsubmitStep(
		long appraisalSettingId, long submitStep) throws SystemException;
