...
import com.liferay.famocom.erpcloud.service.BookingRoomLocalService;
...
/**
 * Provides the base implementation for the booking room local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.BookingRoomLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.BookingRoomLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.BookingRoomLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class BookingRoomLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BookingRoomLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.BookingRoomLocalServiceUtil} to access the booking room local service.
	 */
	...
	@Override
	public BookingRoom addBookingRoom(BookingRoom bookingRoom) {
		bookingRoom.setNew(true);

		return bookingRoomPersistence.update(bookingRoom);
	}
	...
	public BookingRoom createBookingRoom(long bookingId) {
		return bookingRoomPersistence.create(bookingId);
	}
	...
	@Override
	public BookingRoom deleteBookingRoom(long bookingId)
		throws PortalException {
		return bookingRoomPersistence.remove(bookingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BookingRoom deleteBookingRoom(BookingRoom bookingRoom) {
		return bookingRoomPersistence.remove(bookingRoom);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BookingRoom.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return bookingRoomPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return bookingRoomPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return bookingRoomPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BookingRoom fetchBookingRoom(long bookingId) {
		return bookingRoomPersistence.fetchByPrimaryKey(bookingId);
	}
	 ...
	 */
	@Override
	public BookingRoom getBookingRoom(long bookingId) throws PortalException {
		return bookingRoomPersistence.findByPrimaryKey(bookingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(bookingRoomLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BookingRoom.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(bookingRoomLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BookingRoom.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return bookingRoomLocalService.deleteBookingRoom((BookingRoom)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return bookingRoomPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BookingRoom> getBookingRooms(int start, int end) {
		return bookingRoomPersistence.findAll(start, end);
	}
	...
	public int getBookingRoomsCount() {
		return bookingRoomPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BookingRoom updateBookingRoom(BookingRoom bookingRoom) {
		return bookingRoomPersistence.update(bookingRoom);
	}
	 ...
	 */
	public BookingRoomLocalService getBookingRoomLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.BookingRoom",
			bookingRoomLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.BookingRoom");
	}
	...
	public String getOSGiServiceIdentifier() {
		return BookingRoomLocalService.class.getName();
	}
	...
	@BeanReference(type = BookingRoomLocalService.class)
	protected BookingRoomLocalService bookingRoomLocalService;
