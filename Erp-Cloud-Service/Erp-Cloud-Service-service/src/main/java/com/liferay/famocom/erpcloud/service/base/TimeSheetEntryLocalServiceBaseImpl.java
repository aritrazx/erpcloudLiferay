...
/**
 * Provides the base implementation for the time sheet entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.TimeSheetEntryLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class TimeSheetEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TimeSheetEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.TimeSheetEntryLocalServiceUtil} to access the time sheet entry local service.
	 */
	...
	public TimeSheetEntry addTimeSheetEntry(TimeSheetEntry timeSheetEntry) {
		...
		return timeSheetEntryPersistence.update(timeSheetEntry);
	}
	...
	public TimeSheetEntry createTimeSheetEntry(long timesheetId) {
		return timeSheetEntryPersistence.create(timesheetId);
	}
	...
	@Override
	public TimeSheetEntry deleteTimeSheetEntry(long timesheetId)
		throws PortalException {
		return timeSheetEntryPersistence.remove(timesheetId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TimeSheetEntry deleteTimeSheetEntry(TimeSheetEntry timeSheetEntry) {
		return timeSheetEntryPersistence.remove(timeSheetEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TimeSheetEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return timeSheetEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return timeSheetEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TimeSheetEntry fetchTimeSheetEntry(long timesheetId) {
		return timeSheetEntryPersistence.fetchByPrimaryKey(timesheetId);
	}
	 ...
	 */
	@Override
	public TimeSheetEntry getTimeSheetEntry(long timesheetId)
		throws PortalException {
		return timeSheetEntryPersistence.findByPrimaryKey(timesheetId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(timeSheetEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TimeSheetEntry.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(timeSheetEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TimeSheetEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return timeSheetEntryLocalService.deleteTimeSheetEntry((TimeSheetEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return timeSheetEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TimeSheetEntry> getTimeSheetEntries(int start, int end) {
		return timeSheetEntryPersistence.findAll(start, end);
	}
	...
	public int getTimeSheetEntriesCount() {
		return timeSheetEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TimeSheetEntry updateTimeSheetEntry(TimeSheetEntry timeSheetEntry) {
		return timeSheetEntryPersistence.update(timeSheetEntry);
	}
	 ...
	 */
	public TimeSheetEntryLocalService getTimeSheetEntryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.TimeSheetEntry",
			timeSheetEntryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.TimeSheetEntry");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TimeSheetEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = timeSheetEntryPersistence.getDataSource();
	...
	@BeanReference(type = TimeSheetEntryLocalService.class)
	protected TimeSheetEntryLocalService timeSheetEntryLocalService;
