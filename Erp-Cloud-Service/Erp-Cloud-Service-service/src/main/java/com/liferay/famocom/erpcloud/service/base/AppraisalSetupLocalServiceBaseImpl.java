...
import com.liferay.famocom.erpcloud.service.AppraisalSetupLocalService;
...
/**
 * Provides the base implementation for the appraisal setup local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.AppraisalSetupLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.AppraisalSetupLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.AppraisalSetupLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AppraisalSetupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AppraisalSetupLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.AppraisalSetupLocalServiceUtil} to access the appraisal setup local service.
	 */
	...
	@Override
	public AppraisalSetup addAppraisalSetup(AppraisalSetup appraisalSetup) {
		appraisalSetup.setNew(true);

		return appraisalSetupPersistence.update(appraisalSetup);
	}
	...
	public AppraisalSetup createAppraisalSetup(long appraisalSettingId) {
		return appraisalSetupPersistence.create(appraisalSettingId);
	}
	...
	@Override
	public AppraisalSetup deleteAppraisalSetup(long appraisalSettingId)
		throws PortalException {
		return appraisalSetupPersistence.remove(appraisalSettingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AppraisalSetup deleteAppraisalSetup(AppraisalSetup appraisalSetup) {
		return appraisalSetupPersistence.remove(appraisalSetup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AppraisalSetup.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return appraisalSetupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return appraisalSetupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AppraisalSetup fetchAppraisalSetup(long appraisalSettingId) {
		return appraisalSetupPersistence.fetchByPrimaryKey(appraisalSettingId);
	}
	 ...
	 */
	@Override
	public AppraisalSetup getAppraisalSetup(long appraisalSettingId)
		throws PortalException {
		return appraisalSetupPersistence.findByPrimaryKey(appraisalSettingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(appraisalSetupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AppraisalSetup.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("appraisalSettingId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(appraisalSetupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AppraisalSetup.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return appraisalSetupLocalService.deleteAppraisalSetup((AppraisalSetup)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return appraisalSetupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AppraisalSetup> getAppraisalSetups(int start, int end) {
		return appraisalSetupPersistence.findAll(start, end);
	}
	...
	public int getAppraisalSetupsCount() {
		return appraisalSetupPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AppraisalSetup updateAppraisalSetup(AppraisalSetup appraisalSetup) {
		return appraisalSetupPersistence.update(appraisalSetup);
	}
	 ...
	 */
	public AppraisalSetupLocalService getAppraisalSetupLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.AppraisalSetup",
			appraisalSetupLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.AppraisalSetup");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalSetupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = appraisalSetupPersistence.getDataSource();
	...
	@BeanReference(type = AppraisalSetupLocalService.class)
	protected AppraisalSetupLocalService appraisalSetupLocalService;
