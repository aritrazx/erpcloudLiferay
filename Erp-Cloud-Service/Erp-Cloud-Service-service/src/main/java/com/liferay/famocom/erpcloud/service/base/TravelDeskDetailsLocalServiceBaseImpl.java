...
import com.liferay.famocom.erpcloud.service.TravelDeskDetailsLocalService;
...
/**
 * Provides the base implementation for the travel desk details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.TravelDeskDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.TravelDeskDetailsLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.TravelDeskDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TravelDeskDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TravelDeskDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.TravelDeskDetailsLocalServiceUtil} to access the travel desk details local service.
	 */
	...
	@Override
	public TravelDeskDetails addTravelDeskDetails(
		TravelDeskDetails travelDeskDetails) {
		travelDeskDetails.setNew(true);

		return travelDeskDetailsPersistence.update(travelDeskDetails);
	}
	...
	public TravelDeskDetails createTravelDeskDetails(long travelDetailsId) {
		return travelDeskDetailsPersistence.create(travelDetailsId);
	}
	...
	@Override
	public TravelDeskDetails deleteTravelDeskDetails(long travelDetailsId)
		throws PortalException {
		return travelDeskDetailsPersistence.remove(travelDetailsId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TravelDeskDetails deleteTravelDeskDetails(
		TravelDeskDetails travelDeskDetails) {
		return travelDeskDetailsPersistence.remove(travelDeskDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TravelDeskDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return travelDeskDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return travelDeskDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TravelDeskDetails fetchTravelDeskDetails(long travelDetailsId) {
		return travelDeskDetailsPersistence.fetchByPrimaryKey(travelDetailsId);
	}
	 ...
	 */
	@Override
	public TravelDeskDetails getTravelDeskDetails(long travelDetailsId)
		throws PortalException {
		return travelDeskDetailsPersistence.findByPrimaryKey(travelDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(travelDeskDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TravelDeskDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("travelDetailsId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(travelDeskDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TravelDeskDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return travelDeskDetailsLocalService.deleteTravelDeskDetails((TravelDeskDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return travelDeskDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TravelDeskDetails> getTravelDeskDetailses(int start, int end) {
		return travelDeskDetailsPersistence.findAll(start, end);
	}
	...
	public int getTravelDeskDetailsesCount() {
		return travelDeskDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TravelDeskDetails updateTravelDeskDetails(
		TravelDeskDetails travelDeskDetails) {
		return travelDeskDetailsPersistence.update(travelDeskDetails);
	}
	 ...
	 */
	public TravelDeskDetailsLocalService getTravelDeskDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.TravelDeskDetails",
			travelDeskDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.TravelDeskDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDeskDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = travelDeskDetailsPersistence.getDataSource();
	...
	@BeanReference(type = TravelDeskDetailsLocalService.class)
	protected TravelDeskDetailsLocalService travelDeskDetailsLocalService;
