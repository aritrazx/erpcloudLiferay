...
import com.liferay.famocom.erpcloud.service.EmpPayStructureLocalService;
...
/**
 * Provides the base implementation for the emp pay structure local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.EmpPayStructureLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class EmpPayStructureLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmpPayStructureLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.EmpPayStructureLocalServiceUtil} to access the emp pay structure local service.
	 */
	...
	@Override
	public EmpPayStructure addEmpPayStructure(EmpPayStructure empPayStructure) {
		empPayStructure.setNew(true);

		return empPayStructurePersistence.update(empPayStructure);
	}
	...
	public EmpPayStructure createEmpPayStructure(long empPayStructureId) {
		return empPayStructurePersistence.create(empPayStructureId);
	}
	...
	@Override
	public EmpPayStructure deleteEmpPayStructure(long empPayStructureId)
		throws PortalException {
		return empPayStructurePersistence.remove(empPayStructureId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmpPayStructure deleteEmpPayStructure(
		EmpPayStructure empPayStructure) {
		return empPayStructurePersistence.remove(empPayStructure);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmpPayStructure.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return empPayStructurePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return empPayStructurePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmpPayStructure fetchEmpPayStructure(long empPayStructureId) {
		return empPayStructurePersistence.fetchByPrimaryKey(empPayStructureId);
	}
	 ...
	 */
	@Override
	public EmpPayStructure getEmpPayStructure(long empPayStructureId)
		throws PortalException {
		return empPayStructurePersistence.findByPrimaryKey(empPayStructureId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(empPayStructureLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmpPayStructure.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("empPayStructureId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(empPayStructureLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmpPayStructure.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return empPayStructureLocalService.deleteEmpPayStructure((EmpPayStructure)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return empPayStructurePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmpPayStructure> getEmpPayStructures(int start, int end) {
		return empPayStructurePersistence.findAll(start, end);
	}
	...
	public int getEmpPayStructuresCount() {
		return empPayStructurePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmpPayStructure updateEmpPayStructure(
		EmpPayStructure empPayStructure) {
		return empPayStructurePersistence.update(empPayStructure);
	}
	 ...
	 */
	public EmpPayStructureLocalService getEmpPayStructureLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.EmpPayStructure",
			empPayStructureLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.EmpPayStructure");
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmpPayStructureLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = empPayStructurePersistence.getDataSource();
	...
	@BeanReference(type = EmpPayStructureLocalService.class)
	protected EmpPayStructureLocalService empPayStructureLocalService;
