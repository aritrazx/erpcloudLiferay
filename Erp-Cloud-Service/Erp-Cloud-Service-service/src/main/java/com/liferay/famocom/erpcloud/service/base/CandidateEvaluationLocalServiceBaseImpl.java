...
import com.liferay.famocom.erpcloud.service.CandidateEvaluationLocalService;
...
/**
 * Provides the base implementation for the candidate evaluation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.CandidateEvaluationLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.CandidateEvaluationLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.CandidateEvaluationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CandidateEvaluationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CandidateEvaluationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.CandidateEvaluationLocalServiceUtil} to access the candidate evaluation local service.
	 */
	...
	@Override
	public CandidateEvaluation addCandidateEvaluation(
	...
	public CandidateEvaluation createCandidateEvaluation(
		long candidateEvaluationId) {
		return candidateEvaluationPersistence.create(candidateEvaluationId);
	}
	...
	@Override
	public CandidateEvaluation deleteCandidateEvaluation(
		long candidateEvaluationId) throws PortalException {
		return candidateEvaluationPersistence.remove(candidateEvaluationId);
	}
	...
	public CandidateEvaluation deleteCandidateEvaluation(
		CandidateEvaluation candidateEvaluation) {
		return candidateEvaluationPersistence.remove(candidateEvaluation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CandidateEvaluation.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return candidateEvaluationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return candidateEvaluationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CandidateEvaluation fetchCandidateEvaluation(
		long candidateEvaluationId) {
		return candidateEvaluationPersistence.fetchByPrimaryKey(candidateEvaluationId);
	}
	 ...
	 */
	@Override
	public CandidateEvaluation getCandidateEvaluation(
		long candidateEvaluationId) throws PortalException {
		return candidateEvaluationPersistence.findByPrimaryKey(candidateEvaluationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(candidateEvaluationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CandidateEvaluation.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(candidateEvaluationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CandidateEvaluation.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return candidateEvaluationLocalService.deleteCandidateEvaluation((CandidateEvaluation)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return candidateEvaluationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CandidateEvaluation> getCandidateEvaluations(int start, int end) {
	...
	public int getCandidateEvaluationsCount() {
		return candidateEvaluationPersistence.countAll();
	}
	 ...
	 */
	public CandidateEvaluationLocalService getCandidateEvaluationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.CandidateEvaluation",
			candidateEvaluationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.CandidateEvaluation");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CandidateEvaluationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = candidateEvaluationPersistence.getDataSource();
	...
	@BeanReference(type = CandidateEvaluationLocalService.class)
	protected CandidateEvaluationLocalService candidateEvaluationLocalService;
