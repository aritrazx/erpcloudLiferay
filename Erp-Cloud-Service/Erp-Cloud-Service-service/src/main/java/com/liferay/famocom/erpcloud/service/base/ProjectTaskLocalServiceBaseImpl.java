...
/**
 * Provides the base implementation for the project task local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.ProjectTaskLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.ProjectTaskLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.ProjectTaskLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ProjectTaskLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProjectTaskLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.ProjectTaskLocalServiceUtil} to access the project task local service.
	 */
	...
	public ProjectTask addProjectTask(ProjectTask projectTask) {
		...
		return projectTaskPersistence.update(projectTask);
	}
	...
	public ProjectTask createProjectTask(long projectTaskId) {
		return projectTaskPersistence.create(projectTaskId);
	}
	...
	public ProjectTask deleteProjectTask(long projectTaskId)
		...
		return projectTaskPersistence.remove(projectTaskId);
	}
	...
	public ProjectTask deleteProjectTask(ProjectTask projectTask) {
		return projectTaskPersistence.remove(projectTask);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectTask.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectTaskPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return projectTaskPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectTaskPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ProjectTask fetchProjectTask(long projectTaskId) {
		return projectTaskPersistence.fetchByPrimaryKey(projectTaskId);
	}
	...
	public ProjectTask getProjectTask(long projectTaskId)
		throws PortalException {
		return projectTaskPersistence.findByPrimaryKey(projectTaskId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectTaskLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProjectTask.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("projectTaskId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(projectTaskLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProjectTask.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return projectTaskLocalService.deleteProjectTask((ProjectTask)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return projectTaskPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProjectTask> getProjectTasks(int start, int end) {
		return projectTaskPersistence.findAll(start, end);
	}
	...
	public int getProjectTasksCount() {
		return projectTaskPersistence.countAll();
	}
	 ...
	 */
	public ProjectTaskLocalService getProjectTaskLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.ProjectTask",
			projectTaskLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.ProjectTask");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectTaskLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectTaskPersistence.getDataSource();
