...
<%
	...
	filter.setParameter("jspPage", "/META-INF/resources/addEvaluation.jsp");

	PortletURL iteratorUrl = renderResponse.createRenderURL();
	iteratorUrl.setParameter("jspPage", "/META-INF/resources/addEvaluation.jsp");

	PortletURL evaluationuUpdateURL = renderResponse.createRenderURL();
	evaluationuUpdateURL.setParameter("jspPage", "/META-INF/resources/addEvaluation.jsp");
	...
	<aui:row>
		<aui:col span="4">
			<aui:select name="projectRole"
				label="Position/Post" id="ProjectRole" value="">
				<%
...
<liferay-ui:search-container delta="4"
	...
	<liferay-ui:search-container-row
		...
		%>
		<liferay-ui:search-container-column-text name="Position/Post"
