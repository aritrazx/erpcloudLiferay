...
import com.liferay.famocom.erpcloud.service.PayrollIncrementLocalService;
...
/**
 * Provides the base implementation for the payroll increment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.PayrollIncrementLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class PayrollIncrementLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PayrollIncrementLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.PayrollIncrementLocalServiceUtil} to access the payroll increment local service.
	 */
	...
	@Override
	public PayrollIncrement addPayrollIncrement(
		PayrollIncrement payrollIncrement) {
		payrollIncrement.setNew(true);

		return payrollIncrementPersistence.update(payrollIncrement);
	}
	...
	public PayrollIncrement createPayrollIncrement(long payrollIncrementId) {
		return payrollIncrementPersistence.create(payrollIncrementId);
	}
	...
	@Override
	public PayrollIncrement deletePayrollIncrement(long payrollIncrementId)
		throws PortalException {
		return payrollIncrementPersistence.remove(payrollIncrementId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PayrollIncrement deletePayrollIncrement(
		PayrollIncrement payrollIncrement) {
		return payrollIncrementPersistence.remove(payrollIncrement);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PayrollIncrement.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return payrollIncrementPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return payrollIncrementPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PayrollIncrement fetchPayrollIncrement(long payrollIncrementId) {
		return payrollIncrementPersistence.fetchByPrimaryKey(payrollIncrementId);
	}
	 ...
	 */
	@Override
	public PayrollIncrement getPayrollIncrement(long payrollIncrementId)
		throws PortalException {
		return payrollIncrementPersistence.findByPrimaryKey(payrollIncrementId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(payrollIncrementLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PayrollIncrement.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("payrollIncrementId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(payrollIncrementLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PayrollIncrement.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return payrollIncrementLocalService.deletePayrollIncrement((PayrollIncrement)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return payrollIncrementPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PayrollIncrement> getPayrollIncrements(int start, int end) {
		return payrollIncrementPersistence.findAll(start, end);
	}
	...
	public int getPayrollIncrementsCount() {
		return payrollIncrementPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PayrollIncrement updatePayrollIncrement(
		PayrollIncrement payrollIncrement) {
		return payrollIncrementPersistence.update(payrollIncrement);
	}
	 ...
	 */
	public PayrollIncrementLocalService getPayrollIncrementLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.PayrollIncrement",
			payrollIncrementLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.PayrollIncrement");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayrollIncrementLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = payrollIncrementPersistence.getDataSource();
	...
	@BeanReference(type = PayrollIncrementLocalService.class)
	protected PayrollIncrementLocalService payrollIncrementLocalService;
