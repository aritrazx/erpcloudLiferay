...
import com.liferay.famocom.erpcloud.service.WorkFromHomeLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.WorkFromHomeLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.WorkFromHomeLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.WorkFromHomeLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class WorkFromHomeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements WorkFromHomeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.WorkFromHomeLocalServiceUtil} to access the work from home local service.
	 */
	...
	public WorkFromHome createWorkFromHome(long workFromHomeId) {
		return workFromHomePersistence.create(workFromHomeId);
	}
	...
	@Override
	public WorkFromHome deleteWorkFromHome(long workFromHomeId)
		throws PortalException {
		return workFromHomePersistence.remove(workFromHomeId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(WorkFromHome.class,
	...
	@Override
	public WorkFromHome fetchWorkFromHome(long workFromHomeId) {
		return workFromHomePersistence.fetchByPrimaryKey(workFromHomeId);
	}
	 ...
	 */
	@Override
	public WorkFromHome getWorkFromHome(long workFromHomeId)
		throws PortalException {
		return workFromHomePersistence.findByPrimaryKey(workFromHomeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("workFromHomeId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(workFromHomeLocalService);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return workFromHomeLocalService.deleteWorkFromHome((WorkFromHome)persistedModel);
	}
	 ...
	 */
	public WorkFromHomeLocalService getWorkFromHomeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.WorkFromHome",
			workFromHomeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.WorkFromHome");
	}
	...
	@BeanReference(type = WorkFromHomeLocalService.class)
