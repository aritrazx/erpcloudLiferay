...
import com.liferay.famocom.erpcloud.service.payroll.permission.PayComponentModelPermission;
...
@Component(immediate = true, property = {
	    "resource.name=" + PayComponentModelPermission.RESOURCE_NAME
	}, service = ResourcePermissionChecker.class)

public class SalDetailsModelPermission extends BaseResourcePermissionChecker {
