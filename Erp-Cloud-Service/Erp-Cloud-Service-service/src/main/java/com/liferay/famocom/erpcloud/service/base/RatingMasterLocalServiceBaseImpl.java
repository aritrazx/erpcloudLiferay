...
import com.liferay.famocom.erpcloud.service.RatingMasterLocalService;
...
/**
 * Provides the base implementation for the rating master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.RatingMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.RatingMasterLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.RatingMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class RatingMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RatingMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.RatingMasterLocalServiceUtil} to access the rating master local service.
	 */
	...
	@Override
	public RatingMaster addRatingMaster(RatingMaster ratingMaster) {
		ratingMaster.setNew(true);

		return ratingMasterPersistence.update(ratingMaster);
	}
	...
	public RatingMaster createRatingMaster(long ratingId) {
		return ratingMasterPersistence.create(ratingId);
	}
	...
	@Override
	public RatingMaster deleteRatingMaster(long ratingId)
		throws PortalException {
		return ratingMasterPersistence.remove(ratingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RatingMaster deleteRatingMaster(RatingMaster ratingMaster) {
		return ratingMasterPersistence.remove(ratingMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RatingMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ratingMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ratingMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RatingMaster fetchRatingMaster(long ratingId) {
		return ratingMasterPersistence.fetchByPrimaryKey(ratingId);
	}
	 ...
	 */
	@Override
	public RatingMaster getRatingMaster(long ratingId)
		throws PortalException {
		return ratingMasterPersistence.findByPrimaryKey(ratingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ratingMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RatingMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ratingId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ratingMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RatingMaster.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("ratingId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ratingMasterLocalService.deleteRatingMaster((RatingMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ratingMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RatingMaster> getRatingMasters(int start, int end) {
		return ratingMasterPersistence.findAll(start, end);
	}
	...
	public int getRatingMastersCount() {
		return ratingMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RatingMaster updateRatingMaster(RatingMaster ratingMaster) {
		return ratingMasterPersistence.update(ratingMaster);
	}
	 ...
	 */
	public RatingMasterLocalService getRatingMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.RatingMaster",
			ratingMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.RatingMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return RatingMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ratingMasterPersistence.getDataSource();
	...
	@BeanReference(type = RatingMasterLocalService.class)
	protected RatingMasterLocalService ratingMasterLocalService;
