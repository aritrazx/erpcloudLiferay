...
import com.liferay.famocom.erpcloud.service.ConferenceRoomLocalService;
...
/**
 * Provides the base implementation for the conference room local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.ConferenceRoomLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.ConferenceRoomLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.ConferenceRoomLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ConferenceRoomLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ConferenceRoomLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.ConferenceRoomLocalServiceUtil} to access the conference room local service.
	 */
	...
	public ConferenceRoom addConferenceRoom(ConferenceRoom conferenceRoom) {
		...
		return conferenceRoomPersistence.update(conferenceRoom);
	}
	...
	public ConferenceRoom createConferenceRoom(long roomId) {
		return conferenceRoomPersistence.create(roomId);
	}
	...
	@Override
	public ConferenceRoom deleteConferenceRoom(long roomId)
		throws PortalException {
		return conferenceRoomPersistence.remove(roomId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ConferenceRoom deleteConferenceRoom(ConferenceRoom conferenceRoom) {
		return conferenceRoomPersistence.remove(conferenceRoom);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ConferenceRoom.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return conferenceRoomPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return conferenceRoomPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ConferenceRoom fetchConferenceRoom(long roomId) {
		return conferenceRoomPersistence.fetchByPrimaryKey(roomId);
	}
	 ...
	 */
	@Override
	public ConferenceRoom getConferenceRoom(long roomId)
		throws PortalException {
		return conferenceRoomPersistence.findByPrimaryKey(roomId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(conferenceRoomLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ConferenceRoom.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(conferenceRoomLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ConferenceRoom.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return conferenceRoomLocalService.deleteConferenceRoom((ConferenceRoom)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return conferenceRoomPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ConferenceRoom> getConferenceRooms(int start, int end) {
		return conferenceRoomPersistence.findAll(start, end);
	}
	...
	public int getConferenceRoomsCount() {
		return conferenceRoomPersistence.countAll();
	}
	 ...
	 */
	public ConferenceRoomLocalService getConferenceRoomLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.ConferenceRoom",
			conferenceRoomLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.ConferenceRoom");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ConferenceRoomLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = conferenceRoomPersistence.getDataSource();
	...
	@BeanReference(type = ConferenceRoomLocalService.class)
	protected ConferenceRoomLocalService conferenceRoomLocalService;
