...
import com.liferay.famocom.erpcloud.service.TaxDeclarationLocalService;
...
/**
 * Provides the base implementation for the tax declaration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.TaxDeclarationLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class TaxDeclarationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TaxDeclarationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.TaxDeclarationLocalServiceUtil} to access the tax declaration local service.
	 */
	...
	public TaxDeclaration addTaxDeclaration(TaxDeclaration taxDeclaration) {
		...
		return taxDeclarationPersistence.update(taxDeclaration);
	}
	...
	public TaxDeclaration createTaxDeclaration(long taxDeclarationId) {
		return taxDeclarationPersistence.create(taxDeclarationId);
	}
	...
	public TaxDeclaration deleteTaxDeclaration(long taxDeclarationId)
		...
		return taxDeclarationPersistence.remove(taxDeclarationId);
	}
	...
	public TaxDeclaration deleteTaxDeclaration(TaxDeclaration taxDeclaration) {
		return taxDeclarationPersistence.remove(taxDeclaration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TaxDeclaration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return taxDeclarationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return taxDeclarationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public TaxDeclaration fetchTaxDeclaration(long taxDeclarationId) {
		return taxDeclarationPersistence.fetchByPrimaryKey(taxDeclarationId);
	}
	...
	public TaxDeclaration getTaxDeclaration(long taxDeclarationId)
		throws PortalException {
		return taxDeclarationPersistence.findByPrimaryKey(taxDeclarationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(taxDeclarationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TaxDeclaration.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("taxDeclarationId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(taxDeclarationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TaxDeclaration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return taxDeclarationLocalService.deleteTaxDeclaration((TaxDeclaration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return taxDeclarationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TaxDeclaration> getTaxDeclarations(int start, int end) {
		return taxDeclarationPersistence.findAll(start, end);
	}
	...
	public int getTaxDeclarationsCount() {
		return taxDeclarationPersistence.countAll();
	}
	 ...
	 */
	public TaxDeclarationLocalService getTaxDeclarationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.TaxDeclaration",
			taxDeclarationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.TaxDeclaration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TaxDeclarationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = taxDeclarationPersistence.getDataSource();
	...
	@BeanReference(type = TaxDeclarationLocalService.class)
	protected TaxDeclarationLocalService taxDeclarationLocalService;
