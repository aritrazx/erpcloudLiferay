...
import com.liferay.famocom.erpcloud.service.PayrollSlabsLocalService;
...
/**
 * Provides the base implementation for the payroll slabs local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.PayrollSlabsLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class PayrollSlabsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PayrollSlabsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.PayrollSlabsLocalServiceUtil} to access the payroll slabs local service.
	 */
	...
	public PayrollSlabs addPayrollSlabs(PayrollSlabs payrollSlabs) {
		...
		return payrollSlabsPersistence.update(payrollSlabs);
	}
	...
	public PayrollSlabs createPayrollSlabs(long payrollSlabsId) {
		return payrollSlabsPersistence.create(payrollSlabsId);
	}
	...
	public PayrollSlabs deletePayrollSlabs(long payrollSlabsId)
		...
		return payrollSlabsPersistence.remove(payrollSlabsId);
	}
	...
	public PayrollSlabs deletePayrollSlabs(PayrollSlabs payrollSlabs) {
		return payrollSlabsPersistence.remove(payrollSlabs);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PayrollSlabs.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return payrollSlabsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return payrollSlabsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public PayrollSlabs fetchPayrollSlabs(long payrollSlabsId) {
		return payrollSlabsPersistence.fetchByPrimaryKey(payrollSlabsId);
	}
	...
	public PayrollSlabs getPayrollSlabs(long payrollSlabsId)
		throws PortalException {
		return payrollSlabsPersistence.findByPrimaryKey(payrollSlabsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(payrollSlabsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PayrollSlabs.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("payrollSlabsId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(payrollSlabsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PayrollSlabs.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return payrollSlabsLocalService.deletePayrollSlabs((PayrollSlabs)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return payrollSlabsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PayrollSlabs> getPayrollSlabses(int start, int end) {
		return payrollSlabsPersistence.findAll(start, end);
	}
	...
	public int getPayrollSlabsesCount() {
		return payrollSlabsPersistence.countAll();
	}
	 ...
	 */
	public PayrollSlabsLocalService getPayrollSlabsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.PayrollSlabs",
			payrollSlabsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.PayrollSlabs");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayrollSlabsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = payrollSlabsPersistence.getDataSource();
	...
	@BeanReference(type = PayrollSlabsLocalService.class)
	protected PayrollSlabsLocalService payrollSlabsLocalService;
