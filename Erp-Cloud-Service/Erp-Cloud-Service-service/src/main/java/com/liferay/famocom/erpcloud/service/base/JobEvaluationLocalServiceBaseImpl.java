...
import com.liferay.famocom.erpcloud.service.JobEvaluationLocalService;
...
/**
 * Provides the base implementation for the job evaluation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.JobEvaluationLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class JobEvaluationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements JobEvaluationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.JobEvaluationLocalServiceUtil} to access the job evaluation local service.
	 */
	...
	@Override
	public JobEvaluation addJobEvaluation(JobEvaluation jobEvaluation) {
		jobEvaluation.setNew(true);

		return jobEvaluationPersistence.update(jobEvaluation);
	}
	...
	public JobEvaluation createJobEvaluation(long postEvaluationId) {
		return jobEvaluationPersistence.create(postEvaluationId);
	}
	...
	@Override
	public JobEvaluation deleteJobEvaluation(long postEvaluationId)
		throws PortalException {
		return jobEvaluationPersistence.remove(postEvaluationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public JobEvaluation deleteJobEvaluation(JobEvaluation jobEvaluation) {
		return jobEvaluationPersistence.remove(jobEvaluation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(JobEvaluation.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return jobEvaluationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return jobEvaluationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public JobEvaluation fetchJobEvaluation(long postEvaluationId) {
		return jobEvaluationPersistence.fetchByPrimaryKey(postEvaluationId);
	}
	 ...
	 */
	@Override
	public JobEvaluation getJobEvaluation(long postEvaluationId)
		throws PortalException {
		return jobEvaluationPersistence.findByPrimaryKey(postEvaluationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(jobEvaluationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(JobEvaluation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("postEvaluationId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(jobEvaluationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(JobEvaluation.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return jobEvaluationLocalService.deleteJobEvaluation((JobEvaluation)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return jobEvaluationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<JobEvaluation> getJobEvaluations(int start, int end) {
		return jobEvaluationPersistence.findAll(start, end);
	}
	...
	public int getJobEvaluationsCount() {
		return jobEvaluationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public JobEvaluation updateJobEvaluation(JobEvaluation jobEvaluation) {
		return jobEvaluationPersistence.update(jobEvaluation);
	}
	 ...
	 */
	public JobEvaluationLocalService getJobEvaluationLocalService() {
	...
	public void setJobEvaluationLocalService(
		JobEvaluationLocalService jobEvaluationLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.JobEvaluation",
			jobEvaluationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.JobEvaluation");
	}
	...
	public String getOSGiServiceIdentifier() {
		return JobEvaluationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = jobEvaluationPersistence.getDataSource();
	...
	@BeanReference(type = JobEvaluationLocalService.class)
	protected JobEvaluationLocalService jobEvaluationLocalService;
