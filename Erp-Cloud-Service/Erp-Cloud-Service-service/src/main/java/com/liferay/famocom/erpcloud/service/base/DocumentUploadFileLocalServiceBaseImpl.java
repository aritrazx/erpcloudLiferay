...
import com.liferay.famocom.erpcloud.service.DocumentUploadFileLocalService;
...
/**
 * Provides the base implementation for the document upload file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.DocumentUploadFileLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.DocumentUploadFileLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.DocumentUploadFileLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class DocumentUploadFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DocumentUploadFileLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.DocumentUploadFileLocalServiceUtil} to access the document upload file local service.
	 */
	...
	@Override
	public DocumentUploadFile addDocumentUploadFile(
		DocumentUploadFile documentUploadFile) {
		documentUploadFile.setNew(true);

		return documentUploadFilePersistence.update(documentUploadFile);
	}
	...
	public DocumentUploadFile createDocumentUploadFile(long documentId) {
		return documentUploadFilePersistence.create(documentId);
	}
	...
	@Override
	public DocumentUploadFile deleteDocumentUploadFile(long documentId)
		throws PortalException {
		return documentUploadFilePersistence.remove(documentId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DocumentUploadFile deleteDocumentUploadFile(
		DocumentUploadFile documentUploadFile) {
		return documentUploadFilePersistence.remove(documentUploadFile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DocumentUploadFile.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return documentUploadFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return documentUploadFilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DocumentUploadFile fetchDocumentUploadFile(long documentId) {
		return documentUploadFilePersistence.fetchByPrimaryKey(documentId);
	}
	 ...
	 */
	@Override
	public DocumentUploadFile getDocumentUploadFile(long documentId)
		throws PortalException {
		return documentUploadFilePersistence.findByPrimaryKey(documentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(documentUploadFileLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DocumentUploadFile.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(documentUploadFileLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DocumentUploadFile.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return documentUploadFileLocalService.deleteDocumentUploadFile((DocumentUploadFile)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return documentUploadFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DocumentUploadFile> getDocumentUploadFiles(int start, int end) {
		return documentUploadFilePersistence.findAll(start, end);
	}
	...
	public int getDocumentUploadFilesCount() {
		return documentUploadFilePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DocumentUploadFile updateDocumentUploadFile(
		DocumentUploadFile documentUploadFile) {
		return documentUploadFilePersistence.update(documentUploadFile);
	}
	 ...
	 */
	public DocumentUploadFileLocalService getDocumentUploadFileLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.DocumentUploadFile",
			documentUploadFileLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.DocumentUploadFile");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DocumentUploadFileLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = documentUploadFilePersistence.getDataSource();
	...
	@BeanReference(type = DocumentUploadFileLocalService.class)
	protected DocumentUploadFileLocalService documentUploadFileLocalService;
