...
import com.liferay.famocom.erpcloud.service.RecruitProcessLocalService;
...
/**
 * Provides the base implementation for the recruit process local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.RecruitProcessLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class RecruitProcessLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RecruitProcessLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.RecruitProcessLocalServiceUtil} to access the recruit process local service.
	 */
	...
	@Override
	public RecruitProcess addRecruitProcess(RecruitProcess recruitProcess) {
		recruitProcess.setNew(true);

		return recruitProcessPersistence.update(recruitProcess);
	}
	...
	public RecruitProcess createRecruitProcess(long recruitProcessId) {
		return recruitProcessPersistence.create(recruitProcessId);
	}
	...
	@Override
	public RecruitProcess deleteRecruitProcess(long recruitProcessId)
		throws PortalException {
		return recruitProcessPersistence.remove(recruitProcessId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RecruitProcess deleteRecruitProcess(RecruitProcess recruitProcess) {
		return recruitProcessPersistence.remove(recruitProcess);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RecruitProcess.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return recruitProcessPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return recruitProcessPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RecruitProcess fetchRecruitProcess(long recruitProcessId) {
		return recruitProcessPersistence.fetchByPrimaryKey(recruitProcessId);
	}
	 ...
	 */
	@Override
	public RecruitProcess getRecruitProcess(long recruitProcessId)
		throws PortalException {
		return recruitProcessPersistence.findByPrimaryKey(recruitProcessId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(recruitProcessLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RecruitProcess.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("recruitProcessId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(recruitProcessLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RecruitProcess.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return recruitProcessLocalService.deleteRecruitProcess((RecruitProcess)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return recruitProcessPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RecruitProcess> getRecruitProcesses(int start, int end) {
		return recruitProcessPersistence.findAll(start, end);
	}
	...
	public int getRecruitProcessesCount() {
		return recruitProcessPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RecruitProcess updateRecruitProcess(RecruitProcess recruitProcess) {
		return recruitProcessPersistence.update(recruitProcess);
	}
	 ...
	 */
	public RecruitProcessLocalService getRecruitProcessLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.RecruitProcess",
			recruitProcessLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.RecruitProcess");
	}
	...
	public String getOSGiServiceIdentifier() {
		return RecruitProcessLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = recruitProcessPersistence.getDataSource();
	...
	@BeanReference(type = RecruitProcessLocalService.class)
	protected RecruitProcessLocalService recruitProcessLocalService;
