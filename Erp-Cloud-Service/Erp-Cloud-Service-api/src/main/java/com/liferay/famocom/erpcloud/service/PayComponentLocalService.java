...
/**
 * Provides the local service interface for PayComponent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see PayComponentLocalServiceUtil
...
public interface PayComponentLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PayComponentLocalServiceUtil} to access the pay component local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.PayComponentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<PayComponent> findPayComponentByAbbreviationAndComponentId(
		String abbreviation, long payComponentId) throws SystemException;

	public List<PayComponent> findPayComponentByNameAndComponentId(
		String name, long payComponentId) throws SystemException;

	public List<PayComponent> findPayComponentByTaxStatusAndPayType(
		int taxStatus, String payType) throws SystemException;
