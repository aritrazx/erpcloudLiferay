...
import com.liferay.famocom.erpcloud.service.IncomeTaxSlabLocalService;
...
/**
 * Provides the base implementation for the income tax slab local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.IncomeTaxSlabLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.IncomeTaxSlabLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.IncomeTaxSlabLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IncomeTaxSlabLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IncomeTaxSlabLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.IncomeTaxSlabLocalServiceUtil} to access the income tax slab local service.
	 */
	...
	@Override
	public IncomeTaxSlab addIncomeTaxSlab(IncomeTaxSlab incomeTaxSlab) {
		incomeTaxSlab.setNew(true);

		return incomeTaxSlabPersistence.update(incomeTaxSlab);
	}
	...
	public IncomeTaxSlab createIncomeTaxSlab(long incomeTaxSlabId) {
		return incomeTaxSlabPersistence.create(incomeTaxSlabId);
	}
	...
	@Override
	public IncomeTaxSlab deleteIncomeTaxSlab(long incomeTaxSlabId)
		throws PortalException {
		return incomeTaxSlabPersistence.remove(incomeTaxSlabId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IncomeTaxSlab deleteIncomeTaxSlab(IncomeTaxSlab incomeTaxSlab) {
		return incomeTaxSlabPersistence.remove(incomeTaxSlab);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IncomeTaxSlab.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return incomeTaxSlabPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return incomeTaxSlabPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IncomeTaxSlab fetchIncomeTaxSlab(long incomeTaxSlabId) {
		return incomeTaxSlabPersistence.fetchByPrimaryKey(incomeTaxSlabId);
	}
	 ...
	 */
	@Override
	public IncomeTaxSlab getIncomeTaxSlab(long incomeTaxSlabId)
		throws PortalException {
		return incomeTaxSlabPersistence.findByPrimaryKey(incomeTaxSlabId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(incomeTaxSlabLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IncomeTaxSlab.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("incomeTaxSlabId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(incomeTaxSlabLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IncomeTaxSlab.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return incomeTaxSlabLocalService.deleteIncomeTaxSlab((IncomeTaxSlab)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return incomeTaxSlabPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IncomeTaxSlab> getIncomeTaxSlabs(int start, int end) {
		return incomeTaxSlabPersistence.findAll(start, end);
	}
	...
	public int getIncomeTaxSlabsCount() {
		return incomeTaxSlabPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IncomeTaxSlab updateIncomeTaxSlab(IncomeTaxSlab incomeTaxSlab) {
		return incomeTaxSlabPersistence.update(incomeTaxSlab);
	}
	 ...
	 */
	public IncomeTaxSlabLocalService getIncomeTaxSlabLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.IncomeTaxSlab",
			incomeTaxSlabLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.IncomeTaxSlab");
	}
	...
	public String getOSGiServiceIdentifier() {
		return IncomeTaxSlabLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = incomeTaxSlabPersistence.getDataSource();
	...
	@BeanReference(type = IncomeTaxSlabLocalService.class)
	protected IncomeTaxSlabLocalService incomeTaxSlabLocalService;
