...
/**
 * Provides the local service interface for RecruitProcess. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see RecruitProcessLocalServiceUtil
...
public interface RecruitProcessLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RecruitProcessLocalServiceUtil} to access the recruit process local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.RecruitProcessLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Map<Long, String> getResumeFileUpload(String name, File file,
		long userId, String donaminName) throws IOException, PortalException;
