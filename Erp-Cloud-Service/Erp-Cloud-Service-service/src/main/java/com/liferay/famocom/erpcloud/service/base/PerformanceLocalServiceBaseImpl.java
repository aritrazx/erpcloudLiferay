...
import com.liferay.famocom.erpcloud.service.PerformanceLocalService;
...
/**
 * Provides the base implementation for the performance local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.PerformanceLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.PerformanceLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.PerformanceLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class PerformanceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PerformanceLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.PerformanceLocalServiceUtil} to access the performance local service.
	 */
	...
	public Performance addPerformance(Performance performance) {
		...
		return performancePersistence.update(performance);
	}
	...
	public Performance createPerformance(long performanceId) {
		return performancePersistence.create(performanceId);
	}
	...
	@Override
	public Performance deletePerformance(long performanceId)
		throws PortalException {
		return performancePersistence.remove(performanceId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Performance deletePerformance(Performance performance) {
		return performancePersistence.remove(performance);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Performance.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return performancePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return performancePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return performancePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Performance fetchPerformance(long performanceId) {
		return performancePersistence.fetchByPrimaryKey(performanceId);
	}
	...
	public Performance getPerformance(long performanceId)
		throws PortalException {
		return performancePersistence.findByPrimaryKey(performanceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(performanceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Performance.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(performanceLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Performance.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return performanceLocalService.deletePerformance((Performance)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return performancePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Performance> getPerformances(int start, int end) {
		return performancePersistence.findAll(start, end);
	}
	...
	public int getPerformancesCount() {
		return performancePersistence.countAll();
	}
	 ...
	 */
	public PerformanceLocalService getPerformanceLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.Performance",
			performanceLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.Performance");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PerformanceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = performancePersistence.getDataSource();
	...
	@BeanReference(type = PerformanceLocalService.class)
	protected PerformanceLocalService performanceLocalService;
