...
import com.liferay.famocom.erpcloud.service.SchedulesDetailsLocalService;
...
/**
 * Provides the base implementation for the schedules details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.SchedulesDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class SchedulesDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SchedulesDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.SchedulesDetailsLocalServiceUtil} to access the schedules details local service.
	 */
	...
	public SchedulesDetails addSchedulesDetails(
		...
		return schedulesDetailsPersistence.update(schedulesDetails);
	}
	...
	public SchedulesDetails createSchedulesDetails(long schedulesDetailsId) {
		return schedulesDetailsPersistence.create(schedulesDetailsId);
	}
	...
	public SchedulesDetails deleteSchedulesDetails(long schedulesDetailsId)
		...
		return schedulesDetailsPersistence.remove(schedulesDetailsId);
	}
	...
	public SchedulesDetails deleteSchedulesDetails(
		SchedulesDetails schedulesDetails) {
		return schedulesDetailsPersistence.remove(schedulesDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SchedulesDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return schedulesDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return schedulesDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public SchedulesDetails fetchSchedulesDetails(long schedulesDetailsId) {
		return schedulesDetailsPersistence.fetchByPrimaryKey(schedulesDetailsId);
	}
	...
	public SchedulesDetails getSchedulesDetails(long schedulesDetailsId)
		throws PortalException {
		return schedulesDetailsPersistence.findByPrimaryKey(schedulesDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(schedulesDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SchedulesDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("schedulesDetailsId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(schedulesDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SchedulesDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return schedulesDetailsLocalService.deleteSchedulesDetails((SchedulesDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return schedulesDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SchedulesDetails> getSchedulesDetailses(int start, int end) {
		return schedulesDetailsPersistence.findAll(start, end);
	}
	...
	public int getSchedulesDetailsesCount() {
		return schedulesDetailsPersistence.countAll();
	}
	 ...
	 */
	public SchedulesDetailsLocalService getSchedulesDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.SchedulesDetails",
			schedulesDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.SchedulesDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return SchedulesDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = schedulesDetailsPersistence.getDataSource();
	...
	@BeanReference(type = SchedulesDetailsLocalService.class)
	protected SchedulesDetailsLocalService schedulesDetailsLocalService;
