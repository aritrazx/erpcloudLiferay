...
import com.liferay.famocom.erpcloud.service.SchedulesMasterLocalService;
...
/**
 * Provides the base implementation for the schedules master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.SchedulesMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class SchedulesMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SchedulesMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.SchedulesMasterLocalServiceUtil} to access the schedules master local service.
	 */
	...
	public SchedulesMaster addSchedulesMaster(SchedulesMaster schedulesMaster) {
		...
		return schedulesMasterPersistence.update(schedulesMaster);
	}
	...
	public SchedulesMaster createSchedulesMaster(long schedulesId) {
		return schedulesMasterPersistence.create(schedulesId);
	}
	...
	public SchedulesMaster deleteSchedulesMaster(long schedulesId)
		...
		return schedulesMasterPersistence.remove(schedulesId);
	}
	...
	public SchedulesMaster deleteSchedulesMaster(
		...
		return schedulesMasterPersistence.remove(schedulesMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SchedulesMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return schedulesMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return schedulesMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public SchedulesMaster fetchSchedulesMaster(long schedulesId) {
		return schedulesMasterPersistence.fetchByPrimaryKey(schedulesId);
	}
	...
	public SchedulesMaster getSchedulesMaster(long schedulesId)
		throws PortalException {
		return schedulesMasterPersistence.findByPrimaryKey(schedulesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(schedulesMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SchedulesMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("schedulesId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(schedulesMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SchedulesMaster.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("schedulesId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return schedulesMasterLocalService.deleteSchedulesMaster((SchedulesMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return schedulesMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SchedulesMaster> getSchedulesMasters(int start, int end) {
		return schedulesMasterPersistence.findAll(start, end);
	}
	...
	public int getSchedulesMastersCount() {
		return schedulesMasterPersistence.countAll();
	}
	 ...
	 */
	public SchedulesMasterLocalService getSchedulesMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.SchedulesMaster",
			schedulesMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.SchedulesMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return SchedulesMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = schedulesMasterPersistence.getDataSource();
	...
	@BeanReference(type = SchedulesMasterLocalService.class)
	protected SchedulesMasterLocalService schedulesMasterLocalService;
