...
/**
 * Provides the base implementation for the project master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.ProjectMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class ProjectMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProjectMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.ProjectMasterLocalServiceUtil} to access the project master local service.
	 */
	...
	public ProjectMaster addProjectMaster(ProjectMaster projectMaster) {
		...
		return projectMasterPersistence.update(projectMaster);
	}
	...
	public ProjectMaster createProjectMaster(long projectId) {
		return projectMasterPersistence.create(projectId);
	}
	...
	@Override
	public ProjectMaster deleteProjectMaster(long projectId)
		throws PortalException {
		return projectMasterPersistence.remove(projectId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProjectMaster deleteProjectMaster(ProjectMaster projectMaster) {
		return projectMasterPersistence.remove(projectMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProjectMaster fetchProjectMaster(long projectId) {
		return projectMasterPersistence.fetchByPrimaryKey(projectId);
	}
	 ...
	 */
	@Override
	public ProjectMaster getProjectMaster(long projectId)
		throws PortalException {
		return projectMasterPersistence.findByPrimaryKey(projectId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProjectMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(projectMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProjectMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return projectMasterLocalService.deleteProjectMaster((ProjectMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return projectMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProjectMaster> getProjectMasters(int start, int end) {
		return projectMasterPersistence.findAll(start, end);
	}
	...
	public int getProjectMastersCount() {
		return projectMasterPersistence.countAll();
	}
	 ...
	 */
	public ProjectMasterLocalService getProjectMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.ProjectMaster",
			projectMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.ProjectMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectMasterPersistence.getDataSource();
	...
	@BeanReference(type = ProjectMasterLocalService.class)
	protected ProjectMasterLocalService projectMasterLocalService;
