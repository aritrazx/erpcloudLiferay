...
public interface EmployeeLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmployeeLocalServiceUtil} to access the employee local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.EmployeeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<Employee> findEmployeeByStatusAndEmployeeIdNotIn(
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<String[]> getEmployeeByEmployeeStatusAndNotStopPayAndBankName(
	...
	*/
	...
	public Employee updateStatus(long userId, long employeeId, int status,
