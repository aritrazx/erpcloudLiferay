...
import com.liferay.famocom.erpcloud.service.JobOpeningLocalService;
...
/**
 * Provides the base implementation for the job opening local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.JobOpeningLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.JobOpeningLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.JobOpeningLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class JobOpeningLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements JobOpeningLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.JobOpeningLocalServiceUtil} to access the job opening local service.
	 */
	...
	public JobOpening addJobOpening(JobOpening jobOpening) {
		...
		return jobOpeningPersistence.update(jobOpening);
	}
	...
	public JobOpening createJobOpening(long jobOpeningId) {
		return jobOpeningPersistence.create(jobOpeningId);
	}
	...
	@Override
	public JobOpening deleteJobOpening(long jobOpeningId)
		throws PortalException {
		return jobOpeningPersistence.remove(jobOpeningId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public JobOpening deleteJobOpening(JobOpening jobOpening) {
		return jobOpeningPersistence.remove(jobOpening);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(JobOpening.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return jobOpeningPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return jobOpeningPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return jobOpeningPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public JobOpening fetchJobOpening(long jobOpeningId) {
		return jobOpeningPersistence.fetchByPrimaryKey(jobOpeningId);
	}
	...
	public JobOpening getJobOpening(long jobOpeningId)
		throws PortalException {
		return jobOpeningPersistence.findByPrimaryKey(jobOpeningId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(jobOpeningLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(JobOpening.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("jobOpeningId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(jobOpeningLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(JobOpening.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return jobOpeningLocalService.deleteJobOpening((JobOpening)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return jobOpeningPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<JobOpening> getJobOpenings(int start, int end) {
		return jobOpeningPersistence.findAll(start, end);
	}
	...
	public int getJobOpeningsCount() {
		return jobOpeningPersistence.countAll();
	}
	 ...
	 */
	public JobOpeningLocalService getJobOpeningLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.JobOpening",
			jobOpeningLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.JobOpening");
	}
	...
	public String getOSGiServiceIdentifier() {
		return JobOpeningLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = jobOpeningPersistence.getDataSource();
	...
	@BeanReference(type = JobOpeningLocalService.class)
	protected JobOpeningLocalService jobOpeningLocalService;
