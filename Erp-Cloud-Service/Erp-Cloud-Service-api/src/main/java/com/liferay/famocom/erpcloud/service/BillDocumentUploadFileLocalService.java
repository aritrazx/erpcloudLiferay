...
/**
 * Provides the local service interface for BillDocumentUploadFile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see BillDocumentUploadFileLocalServiceUtil
...
public interface BillDocumentUploadFileLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BillDocumentUploadFileLocalServiceUtil} to access the bill document upload file local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.BillDocumentUploadFileLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
