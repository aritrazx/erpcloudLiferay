...
import com.liferay.famocom.erpcloud.service.BillDocumentUploadFileLocalService;
...
/**
 * Provides the base implementation for the bill document upload file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.BillDocumentUploadFileLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.BillDocumentUploadFileLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.BillDocumentUploadFileLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class BillDocumentUploadFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BillDocumentUploadFileLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.BillDocumentUploadFileLocalServiceUtil} to access the bill document upload file local service.
	 */
	...
	@Override
	public BillDocumentUploadFile addBillDocumentUploadFile(
		BillDocumentUploadFile billDocumentUploadFile) {
		billDocumentUploadFile.setNew(true);

		return billDocumentUploadFilePersistence.update(billDocumentUploadFile);
	}
	...
	public BillDocumentUploadFile createBillDocumentUploadFile(long documentId) {
		return billDocumentUploadFilePersistence.create(documentId);
	}
	...
	@Override
	public BillDocumentUploadFile deleteBillDocumentUploadFile(long documentId)
		throws PortalException {
		return billDocumentUploadFilePersistence.remove(documentId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BillDocumentUploadFile deleteBillDocumentUploadFile(
		BillDocumentUploadFile billDocumentUploadFile) {
		return billDocumentUploadFilePersistence.remove(billDocumentUploadFile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BillDocumentUploadFile.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return billDocumentUploadFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return billDocumentUploadFilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BillDocumentUploadFile fetchBillDocumentUploadFile(long documentId) {
		return billDocumentUploadFilePersistence.fetchByPrimaryKey(documentId);
	}
	 ...
	 */
	@Override
	public BillDocumentUploadFile getBillDocumentUploadFile(long documentId)
		throws PortalException {
		return billDocumentUploadFilePersistence.findByPrimaryKey(documentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(billDocumentUploadFileLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BillDocumentUploadFile.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(billDocumentUploadFileLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BillDocumentUploadFile.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return billDocumentUploadFileLocalService.deleteBillDocumentUploadFile((BillDocumentUploadFile)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return billDocumentUploadFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BillDocumentUploadFile> getBillDocumentUploadFiles(int start,
		int end) {
		return billDocumentUploadFilePersistence.findAll(start, end);
	}
	...
	public int getBillDocumentUploadFilesCount() {
		return billDocumentUploadFilePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BillDocumentUploadFile updateBillDocumentUploadFile(
		BillDocumentUploadFile billDocumentUploadFile) {
		return billDocumentUploadFilePersistence.update(billDocumentUploadFile);
	}
	 ...
	 */
	public BillDocumentUploadFileLocalService getBillDocumentUploadFileLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.BillDocumentUploadFile",
			billDocumentUploadFileLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.BillDocumentUploadFile");
	}
	...
	public String getOSGiServiceIdentifier() {
		return BillDocumentUploadFileLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = billDocumentUploadFilePersistence.getDataSource();
	...
	@BeanReference(type = BillDocumentUploadFileLocalService.class)
	protected BillDocumentUploadFileLocalService billDocumentUploadFileLocalService;
