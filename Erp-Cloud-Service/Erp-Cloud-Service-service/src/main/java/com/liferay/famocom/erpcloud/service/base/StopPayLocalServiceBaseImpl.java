...
import com.liferay.famocom.erpcloud.service.StopPayLocalService;
...
/**
 * Provides the base implementation for the stop pay local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.StopPayLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.StopPayLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.StopPayLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StopPayLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements StopPayLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.StopPayLocalServiceUtil} to access the stop pay local service.
	 */
	...
	@Override
	public StopPay addStopPay(StopPay stopPay) {
		stopPay.setNew(true);

		return stopPayPersistence.update(stopPay);
	}
	...
	public StopPay createStopPay(long stopPayId) {
		return stopPayPersistence.create(stopPayId);
	}
	...
	@Override
	public StopPay deleteStopPay(long stopPayId) throws PortalException {
		return stopPayPersistence.remove(stopPayId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StopPay deleteStopPay(StopPay stopPay) {
		return stopPayPersistence.remove(stopPay);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StopPay.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stopPayPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return stopPayPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return stopPayPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stopPayPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return stopPayPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public StopPay fetchStopPay(long stopPayId) {
		return stopPayPersistence.fetchByPrimaryKey(stopPayId);
	}
	 ...
	 */
	@Override
	public StopPay getStopPay(long stopPayId) throws PortalException {
		return stopPayPersistence.findByPrimaryKey(stopPayId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stopPayLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StopPay.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("stopPayId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(stopPayLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(StopPay.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("stopPayId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stopPayLocalService.deleteStopPay((StopPay)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stopPayPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StopPay> getStopPaies(int start, int end) {
		return stopPayPersistence.findAll(start, end);
	}
	...
	public int getStopPaiesCount() {
		return stopPayPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StopPay updateStopPay(StopPay stopPay) {
		return stopPayPersistence.update(stopPay);
	}
	 ...
	 */
	public StopPayLocalService getStopPayLocalService() {
	 ...
	 */
	public void setStopPayLocalService(StopPayLocalService stopPayLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.StopPay",
			stopPayLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.StopPay");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StopPayLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stopPayPersistence.getDataSource();
	...
	@BeanReference(type = StopPayLocalService.class)
	protected StopPayLocalService stopPayLocalService;
