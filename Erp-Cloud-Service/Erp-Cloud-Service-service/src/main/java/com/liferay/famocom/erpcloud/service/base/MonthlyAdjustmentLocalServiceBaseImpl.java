...
import com.liferay.famocom.erpcloud.service.MonthlyAdjustmentLocalService;
...
/**
 * Provides the base implementation for the monthly adjustment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.MonthlyAdjustmentLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class MonthlyAdjustmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MonthlyAdjustmentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.MonthlyAdjustmentLocalServiceUtil} to access the monthly adjustment local service.
	 */
	...
	public MonthlyAdjustment addMonthlyAdjustment(
		...
		return monthlyAdjustmentPersistence.update(monthlyAdjustment);
	}
	...
	public MonthlyAdjustment createMonthlyAdjustment(long monthlyAdjustmentId) {
		return monthlyAdjustmentPersistence.create(monthlyAdjustmentId);
	}
	...
	public MonthlyAdjustment deleteMonthlyAdjustment(long monthlyAdjustmentId)
		...
		return monthlyAdjustmentPersistence.remove(monthlyAdjustmentId);
	}
	...
	public MonthlyAdjustment deleteMonthlyAdjustment(
		MonthlyAdjustment monthlyAdjustment) {
		return monthlyAdjustmentPersistence.remove(monthlyAdjustment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MonthlyAdjustment.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return monthlyAdjustmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return monthlyAdjustmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public MonthlyAdjustment fetchMonthlyAdjustment(long monthlyAdjustmentId) {
		return monthlyAdjustmentPersistence.fetchByPrimaryKey(monthlyAdjustmentId);
	}
	...
	public MonthlyAdjustment getMonthlyAdjustment(long monthlyAdjustmentId)
		throws PortalException {
		return monthlyAdjustmentPersistence.findByPrimaryKey(monthlyAdjustmentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(monthlyAdjustmentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MonthlyAdjustment.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("monthlyAdjustmentId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(monthlyAdjustmentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MonthlyAdjustment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return monthlyAdjustmentLocalService.deleteMonthlyAdjustment((MonthlyAdjustment)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return monthlyAdjustmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MonthlyAdjustment> getMonthlyAdjustments(int start, int end) {
		return monthlyAdjustmentPersistence.findAll(start, end);
	}
	...
	public int getMonthlyAdjustmentsCount() {
		return monthlyAdjustmentPersistence.countAll();
	}
	 ...
	 */
	public MonthlyAdjustmentLocalService getMonthlyAdjustmentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.MonthlyAdjustment",
			monthlyAdjustmentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.MonthlyAdjustment");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MonthlyAdjustmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = monthlyAdjustmentPersistence.getDataSource();
	...
	@BeanReference(type = MonthlyAdjustmentLocalService.class)
	protected MonthlyAdjustmentLocalService monthlyAdjustmentLocalService;
