...
/**
 * Provides the local service interface for EmpPayStructure. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see EmpPayStructureLocalServiceUtil
...
public interface EmpPayStructureLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmpPayStructureLocalServiceUtil} to access the emp pay structure local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.EmpPayStructureLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public EmpPayStructure findByemployeeIdPayComponentId(long employeeId,
		long payComponentId) throws SystemException;

	public List<EmpPayStructure> findEmpPayStructureByEmployeeId(
		long employeeId) throws SystemException;

	public List<EmpPayStructure> findEmpPayStructureByPayComponentId(
		long paycomponentId) throws SystemException;

	public EmpPayStructure findEmpPayStructureByPayComponentIdAndEmployeeId(
		long paycomponentId, long employeeId)
		throws SystemException, NoSuchEmpPayStructureException;

	public List<EmpPayStructure> findEmpPayStructureByPayComponentIdsAndEmployeeId(
		long[] paycomponentIds, long employeeId) throws SystemException;
