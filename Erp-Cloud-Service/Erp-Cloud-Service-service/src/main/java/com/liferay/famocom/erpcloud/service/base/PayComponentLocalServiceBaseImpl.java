...
/**
 * Provides the base implementation for the pay component local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.PayComponentLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class PayComponentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PayComponentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.PayComponentLocalServiceUtil} to access the pay component local service.
	 */
	...
	@Override
	public PayComponent addPayComponent(PayComponent payComponent) {
		payComponent.setNew(true);

		return payComponentPersistence.update(payComponent);
	}
	...
	public PayComponent createPayComponent(long componentId) {
		return payComponentPersistence.create(componentId);
	}
	...
	@Override
	public PayComponent deletePayComponent(long componentId)
		throws PortalException {
		return payComponentPersistence.remove(componentId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PayComponent deletePayComponent(PayComponent payComponent) {
		return payComponentPersistence.remove(payComponent);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PayComponent.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return payComponentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return payComponentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PayComponent fetchPayComponent(long componentId) {
		return payComponentPersistence.fetchByPrimaryKey(componentId);
	}
	 ...
	 */
	@Override
	public PayComponent getPayComponent(long componentId)
		throws PortalException {
		return payComponentPersistence.findByPrimaryKey(componentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(payComponentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PayComponent.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("componentId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(payComponentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PayComponent.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("componentId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return payComponentLocalService.deletePayComponent((PayComponent)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return payComponentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PayComponent> getPayComponents(int start, int end) {
		return payComponentPersistence.findAll(start, end);
	}
	...
	public int getPayComponentsCount() {
		return payComponentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PayComponent updatePayComponent(PayComponent payComponent) {
		return payComponentPersistence.update(payComponent);
	}
	 ...
	 */
	public PayComponentLocalService getPayComponentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.PayComponent",
			payComponentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.PayComponent");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PayComponentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = payComponentPersistence.getDataSource();
	...
	@BeanReference(type = PayComponentLocalService.class)
	protected PayComponentLocalService payComponentLocalService;
