...
import com.liferay.famocom.erpcloud.service.NotificationMasterManageLocalService;
...
/**
 * Provides the base implementation for the notification master manage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.NotificationMasterManageLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.NotificationMasterManageLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.NotificationMasterManageLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class NotificationMasterManageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NotificationMasterManageLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.NotificationMasterManageLocalServiceUtil} to access the notification master manage local service.
	 */
	...
	@Override
	public NotificationMasterManage addNotificationMasterManage(
		NotificationMasterManage notificationMasterManage) {
		notificationMasterManage.setNew(true);

		return notificationMasterManagePersistence.update(notificationMasterManage);
	}
	...
	public NotificationMasterManage createNotificationMasterManage(
		long notifyId) {
		return notificationMasterManagePersistence.create(notifyId);
	}
	...
	@Override
	public NotificationMasterManage deleteNotificationMasterManage(
		long notifyId) throws PortalException {
		return notificationMasterManagePersistence.remove(notifyId);
	}
	...
	public NotificationMasterManage deleteNotificationMasterManage(
		NotificationMasterManage notificationMasterManage) {
		return notificationMasterManagePersistence.remove(notificationMasterManage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NotificationMasterManage.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return notificationMasterManagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return notificationMasterManagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NotificationMasterManage fetchNotificationMasterManage(long notifyId) {
		return notificationMasterManagePersistence.fetchByPrimaryKey(notifyId);
	}
	 ...
	 */
	@Override
	public NotificationMasterManage getNotificationMasterManage(long notifyId)
		throws PortalException {
		return notificationMasterManagePersistence.findByPrimaryKey(notifyId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(notificationMasterManageLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NotificationMasterManage.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("notifyId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(notificationMasterManageLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NotificationMasterManage.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("notifyId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return notificationMasterManageLocalService.deleteNotificationMasterManage((NotificationMasterManage)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return notificationMasterManagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NotificationMasterManage> getNotificationMasterManages(
		int start, int end) {
		return notificationMasterManagePersistence.findAll(start, end);
	}
	...
	public int getNotificationMasterManagesCount() {
		return notificationMasterManagePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NotificationMasterManage updateNotificationMasterManage(
		NotificationMasterManage notificationMasterManage) {
		return notificationMasterManagePersistence.update(notificationMasterManage);
	}
	 ...
	 */
	public NotificationMasterManageLocalService getNotificationMasterManageLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.NotificationMasterManage",
			notificationMasterManageLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.NotificationMasterManage");
	}
	...
	public String getOSGiServiceIdentifier() {
		return NotificationMasterManageLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = notificationMasterManagePersistence.getDataSource();
	...
	@BeanReference(type = NotificationMasterManageLocalService.class)
	protected NotificationMasterManageLocalService notificationMasterManageLocalService;
