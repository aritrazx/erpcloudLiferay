...
import com.liferay.famocom.erpcloud.service.ClientMasterLocalService;
...
/**
 * Provides the base implementation for the client master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.ClientMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.ClientMasterLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.ClientMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ClientMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ClientMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.ClientMasterLocalServiceUtil} to access the client master local service.
	 */
	...
	public ClientMaster addClientMaster(ClientMaster clientMaster) {
		...
		return clientMasterPersistence.update(clientMaster);
	}
	...
	public ClientMaster createClientMaster(long clientId) {
		return clientMasterPersistence.create(clientId);
	}
	...
	@Override
	public ClientMaster deleteClientMaster(long clientId)
		throws PortalException {
		return clientMasterPersistence.remove(clientId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ClientMaster deleteClientMaster(ClientMaster clientMaster) {
		return clientMasterPersistence.remove(clientMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ClientMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return clientMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return clientMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ClientMaster fetchClientMaster(long clientId) {
		return clientMasterPersistence.fetchByPrimaryKey(clientId);
	}
	 ...
	 */
	@Override
	public ClientMaster getClientMaster(long clientId)
		throws PortalException {
		return clientMasterPersistence.findByPrimaryKey(clientId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(clientMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ClientMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(clientMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ClientMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return clientMasterLocalService.deleteClientMaster((ClientMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return clientMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ClientMaster> getClientMasters(int start, int end) {
		return clientMasterPersistence.findAll(start, end);
	}
	...
	public int getClientMastersCount() {
		return clientMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ClientMaster updateClientMaster(ClientMaster clientMaster) {
		return clientMasterPersistence.update(clientMaster);
	}
	 ...
	 */
	public ClientMasterLocalService getClientMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.ClientMaster",
			clientMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.ClientMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ClientMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = clientMasterPersistence.getDataSource();
	...
	@BeanReference(type = ClientMasterLocalService.class)
	protected ClientMasterLocalService clientMasterLocalService;
