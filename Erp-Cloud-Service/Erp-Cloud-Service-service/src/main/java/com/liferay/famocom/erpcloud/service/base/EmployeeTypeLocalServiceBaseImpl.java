...
import com.liferay.famocom.erpcloud.service.EmployeeTypeLocalService;
...
/**
 * Provides the base implementation for the employee type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.EmployeeTypeLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.EmployeeTypeLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.EmployeeTypeLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class EmployeeTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmployeeTypeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.EmployeeTypeLocalServiceUtil} to access the employee type local service.
	 */
	...
	public EmployeeType addEmployeeType(EmployeeType employeeType) {
		...
		return employeeTypePersistence.update(employeeType);
	}
	...
	public EmployeeType createEmployeeType(long employeetypeId) {
		return employeeTypePersistence.create(employeetypeId);
	}
	...
	@Override
	public EmployeeType deleteEmployeeType(long employeetypeId)
		throws PortalException {
		return employeeTypePersistence.remove(employeetypeId);
	}
	...
	public EmployeeType deleteEmployeeType(EmployeeType employeeType) {
		return employeeTypePersistence.remove(employeeType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmployeeType.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmployeeType fetchEmployeeType(long employeetypeId) {
		return employeeTypePersistence.fetchByPrimaryKey(employeetypeId);
	}
	...
	public EmployeeType getEmployeeType(long employeetypeId)
		throws PortalException {
		return employeeTypePersistence.findByPrimaryKey(employeetypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("employeetypeId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(employeeTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeType.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return employeeTypeLocalService.deleteEmployeeType((EmployeeType)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return employeeTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeType> getEmployeeTypes(int start, int end) {
		return employeeTypePersistence.findAll(start, end);
	}
	...
	public int getEmployeeTypesCount() {
		return employeeTypePersistence.countAll();
	}
	 ...
	 */
	public EmployeeTypeLocalService getEmployeeTypeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.EmployeeType",
			employeeTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.EmployeeType");
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeTypePersistence.getDataSource();
	...
	@BeanReference(type = EmployeeTypeLocalService.class)
	protected EmployeeTypeLocalService employeeTypeLocalService;
