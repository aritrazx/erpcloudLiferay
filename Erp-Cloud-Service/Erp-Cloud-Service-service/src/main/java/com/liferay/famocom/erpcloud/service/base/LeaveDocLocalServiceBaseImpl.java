...
import com.liferay.famocom.erpcloud.service.LeaveDocLocalService;
...
/**
 * Provides the base implementation for the leave doc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.LeaveDocLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class LeaveDocLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LeaveDocLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.LeaveDocLocalServiceUtil} to access the leave doc local service.
	 */
	...
	@Override
	public LeaveDoc addLeaveDoc(LeaveDoc leaveDoc) {
		leaveDoc.setNew(true);

		return leaveDocPersistence.update(leaveDoc);
	}
	...
	public LeaveDoc createLeaveDoc(long leaveDocId) {
		return leaveDocPersistence.create(leaveDocId);
	}
	...
	@Override
	public LeaveDoc deleteLeaveDoc(long leaveDocId) throws PortalException {
		return leaveDocPersistence.remove(leaveDocId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveDoc deleteLeaveDoc(LeaveDoc leaveDoc) {
		return leaveDocPersistence.remove(leaveDoc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveDoc.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return leaveDocPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return leaveDocPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return leaveDocPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return leaveDocPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LeaveDoc fetchLeaveDoc(long leaveDocId) {
		return leaveDocPersistence.fetchByPrimaryKey(leaveDocId);
	}
	 ...
	 */
	@Override
	public LeaveDoc getLeaveDoc(long leaveDocId) throws PortalException {
		return leaveDocPersistence.findByPrimaryKey(leaveDocId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(leaveDocLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LeaveDoc.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("leaveDocId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(leaveDocLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LeaveDoc.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("leaveDocId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return leaveDocLocalService.deleteLeaveDoc((LeaveDoc)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return leaveDocPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveDoc> getLeaveDocs(int start, int end) {
		return leaveDocPersistence.findAll(start, end);
	}
	...
	public int getLeaveDocsCount() {
		return leaveDocPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveDoc updateLeaveDoc(LeaveDoc leaveDoc) {
		return leaveDocPersistence.update(leaveDoc);
	}
	 ...
	 */
	public LeaveDocLocalService getLeaveDocLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.LeaveDoc",
			leaveDocLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.LeaveDoc");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveDocLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = leaveDocPersistence.getDataSource();
	...
	@BeanReference(type = LeaveDocLocalService.class)
	protected LeaveDocLocalService leaveDocLocalService;
