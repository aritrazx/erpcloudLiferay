...
import com.liferay.famocom.erpcloud.service.TaxProofFilesLocalService;
...
/**
 * Provides the base implementation for the tax proof files local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.TaxProofFilesLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.TaxProofFilesLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.TaxProofFilesLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TaxProofFilesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TaxProofFilesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.TaxProofFilesLocalServiceUtil} to access the tax proof files local service.
	 */
	...
	@Override
	public TaxProofFiles addTaxProofFiles(TaxProofFiles taxProofFiles) {
		taxProofFiles.setNew(true);

		return taxProofFilesPersistence.update(taxProofFiles);
	}
	...
	public TaxProofFiles createTaxProofFiles(long fileId) {
		return taxProofFilesPersistence.create(fileId);
	}
	...
	@Override
	public TaxProofFiles deleteTaxProofFiles(long fileId)
		throws PortalException {
		return taxProofFilesPersistence.remove(fileId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TaxProofFiles deleteTaxProofFiles(TaxProofFiles taxProofFiles) {
		return taxProofFilesPersistence.remove(taxProofFiles);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TaxProofFiles.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return taxProofFilesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return taxProofFilesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TaxProofFiles fetchTaxProofFiles(long fileId) {
		return taxProofFilesPersistence.fetchByPrimaryKey(fileId);
	}
	 ...
	 */
	@Override
	public TaxProofFiles getTaxProofFiles(long fileId)
		throws PortalException {
		return taxProofFilesPersistence.findByPrimaryKey(fileId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(taxProofFilesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TaxProofFiles.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(taxProofFilesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TaxProofFiles.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return taxProofFilesLocalService.deleteTaxProofFiles((TaxProofFiles)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return taxProofFilesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TaxProofFiles> getTaxProofFileses(int start, int end) {
		return taxProofFilesPersistence.findAll(start, end);
	}
	...
	public int getTaxProofFilesesCount() {
		return taxProofFilesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TaxProofFiles updateTaxProofFiles(TaxProofFiles taxProofFiles) {
		return taxProofFilesPersistence.update(taxProofFiles);
	}
	 ...
	 */
	public TaxProofFilesLocalService getTaxProofFilesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.TaxProofFiles",
			taxProofFilesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.TaxProofFiles");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TaxProofFilesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = taxProofFilesPersistence.getDataSource();
	...
	@BeanReference(type = TaxProofFilesLocalService.class)
	protected TaxProofFilesLocalService taxProofFilesLocalService;
