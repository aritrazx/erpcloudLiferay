...
import com.liferay.famocom.erpcloud.service.GoalDetailsLocalService;
...
/**
 * Provides the base implementation for the goal details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.GoalDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.GoalDetailsLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.GoalDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class GoalDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GoalDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.GoalDetailsLocalServiceUtil} to access the goal details local service.
	 */

	/**
	 * Adds the goal details to the database. Also notifies the appropriate model listeners.
	 *
	 * @param goalDetails the goal details
	 * @return the goal details that was added
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GoalDetails addGoalDetails(GoalDetails goalDetails) {
		goalDetails.setNew(true);

		return goalDetailsPersistence.update(goalDetails);
	}
	...
	public GoalDetails createGoalDetails(long goaldetailId) {
		return goalDetailsPersistence.create(goaldetailId);
	}

	/**
	 * Deletes the goal details with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param goaldetailId the primary key of the goal details
	 * @return the goal details that was removed
	 * @throws PortalException if a goal details with the primary key could not be found
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GoalDetails deleteGoalDetails(long goaldetailId)
		throws PortalException {
		return goalDetailsPersistence.remove(goaldetailId);
	}

	/**
	 * Deletes the goal details from the database. Also notifies the appropriate model listeners.
	 *
	 * @param goalDetails the goal details
	 * @return the goal details that was removed
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GoalDetails deleteGoalDetails(GoalDetails goalDetails) {
		return goalDetailsPersistence.remove(goalDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GoalDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return goalDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return goalDetailsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return goalDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GoalDetails fetchGoalDetails(long goaldetailId) {
		return goalDetailsPersistence.fetchByPrimaryKey(goaldetailId);
	}

	/**
	 * Returns the goal details with the primary key.
	 *
	 * @param goaldetailId the primary key of the goal details
	 ...
	 */
	@Override
	public GoalDetails getGoalDetails(long goaldetailId)
		throws PortalException {
		return goalDetailsPersistence.findByPrimaryKey(goaldetailId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(goalDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(GoalDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("goaldetailId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(goalDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(GoalDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return goalDetailsLocalService.deleteGoalDetails((GoalDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return goalDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GoalDetails> getGoalDetailses(int start, int end) {
		return goalDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGoalDetailsesCount() {
		return goalDetailsPersistence.countAll();
	}

	/**
	 * Updates the goal details in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param goalDetails the goal details
	 * @return the goal details that was updated
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GoalDetails updateGoalDetails(GoalDetails goalDetails) {
		return goalDetailsPersistence.update(goalDetails);
	}
	 ...
	 */
	public GoalDetailsLocalService getGoalDetailsLocalService() {
	...
	public void setGoalDetailsLocalService(
		GoalDetailsLocalService goalDetailsLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.GoalDetails",
			goalDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.GoalDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return GoalDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = goalDetailsPersistence.getDataSource();
	...
	@BeanReference(type = GoalDetailsLocalService.class)
	protected GoalDetailsLocalService goalDetailsLocalService;
