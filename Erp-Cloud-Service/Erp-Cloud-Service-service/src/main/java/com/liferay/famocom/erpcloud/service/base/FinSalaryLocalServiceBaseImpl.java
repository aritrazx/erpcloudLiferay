...
import com.liferay.famocom.erpcloud.service.FinSalaryLocalService;
...
/**
 * Provides the base implementation for the fin salary local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.FinSalaryLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.FinSalaryLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.FinSalaryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class FinSalaryLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements FinSalaryLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.FinSalaryLocalServiceUtil} to access the fin salary local service.
	 */
	...
	public FinSalary addFinSalary(FinSalary finSalary) {
		...
		return finSalaryPersistence.update(finSalary);
	}
	...
	public FinSalary createFinSalary(long finSalaryId) {
		return finSalaryPersistence.create(finSalaryId);
	}
	...
	public FinSalary deleteFinSalary(long finSalaryId)
		...
		return finSalaryPersistence.remove(finSalaryId);
	}
	...
	public FinSalary deleteFinSalary(FinSalary finSalary) {
		return finSalaryPersistence.remove(finSalary);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FinSalary.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return finSalaryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return finSalaryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return finSalaryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public FinSalary fetchFinSalary(long finSalaryId) {
		return finSalaryPersistence.fetchByPrimaryKey(finSalaryId);
	}
	...
	public FinSalary getFinSalary(long finSalaryId) throws PortalException {
		return finSalaryPersistence.findByPrimaryKey(finSalaryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(finSalaryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FinSalary.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("finSalaryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(finSalaryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FinSalary.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("finSalaryId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return finSalaryLocalService.deleteFinSalary((FinSalary)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return finSalaryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FinSalary> getFinSalaries(int start, int end) {
		return finSalaryPersistence.findAll(start, end);
	}
	...
	public int getFinSalariesCount() {
		return finSalaryPersistence.countAll();
	}
	 ...
	 */
	public FinSalaryLocalService getFinSalaryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.FinSalary",
			finSalaryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.FinSalary");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FinSalaryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = finSalaryPersistence.getDataSource();
	...
	@BeanReference(type = FinSalaryLocalService.class)
	protected FinSalaryLocalService finSalaryLocalService;
