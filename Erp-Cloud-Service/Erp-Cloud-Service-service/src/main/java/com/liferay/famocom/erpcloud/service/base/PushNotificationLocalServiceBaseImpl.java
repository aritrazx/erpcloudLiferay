...
import com.liferay.famocom.erpcloud.service.PushNotificationLocalService;
...
/**
 * Provides the base implementation for the push notification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.PushNotificationLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.PushNotificationLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.PushNotificationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class PushNotificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PushNotificationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.PushNotificationLocalServiceUtil} to access the push notification local service.
	 */
	...
	@Override
	public PushNotification addPushNotification(
		PushNotification pushNotification) {
		pushNotification.setNew(true);

		return pushNotificationPersistence.update(pushNotification);
	}
	...
	public PushNotification createPushNotification(long pushNotificationId) {
		return pushNotificationPersistence.create(pushNotificationId);
	}
	...
	@Override
	public PushNotification deletePushNotification(long pushNotificationId)
		throws PortalException {
		return pushNotificationPersistence.remove(pushNotificationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PushNotification deletePushNotification(
		PushNotification pushNotification) {
		return pushNotificationPersistence.remove(pushNotification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PushNotification.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return pushNotificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return pushNotificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PushNotification fetchPushNotification(long pushNotificationId) {
		return pushNotificationPersistence.fetchByPrimaryKey(pushNotificationId);
	}
	 ...
	 */
	@Override
	public PushNotification getPushNotification(long pushNotificationId)
		throws PortalException {
		return pushNotificationPersistence.findByPrimaryKey(pushNotificationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(pushNotificationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PushNotification.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("pushNotificationId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(pushNotificationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PushNotification.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return pushNotificationLocalService.deletePushNotification((PushNotification)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return pushNotificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PushNotification> getPushNotifications(int start, int end) {
		return pushNotificationPersistence.findAll(start, end);
	}
	...
	public int getPushNotificationsCount() {
		return pushNotificationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PushNotification updatePushNotification(
		PushNotification pushNotification) {
		return pushNotificationPersistence.update(pushNotification);
	}
	 ...
	 */
	public PushNotificationLocalService getPushNotificationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.PushNotification",
			pushNotificationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.PushNotification");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PushNotificationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = pushNotificationPersistence.getDataSource();
	...
	@BeanReference(type = PushNotificationLocalService.class)
	protected PushNotificationLocalService pushNotificationLocalService;
