...
@Component(immediate = true, property = {
		"resource.name=" + ProjectMasterModelPermission.RESOURCE_NAME }, service = ResourcePermissionChecker.class)

public class ProjectMasterModelPermission extends BaseResourcePermissionChecker {
