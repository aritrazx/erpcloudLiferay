...
import com.liferay.famocom.erpcloud.service.AppraisalMasterLocalService;
...
/**
 * Provides the base implementation for the appraisal master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.AppraisalMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.AppraisalMasterLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.AppraisalMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AppraisalMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AppraisalMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.AppraisalMasterLocalServiceUtil} to access the appraisal master local service.
	 */
	...
	@Override
	public AppraisalMaster addAppraisalMaster(AppraisalMaster appraisalMaster) {
		appraisalMaster.setNew(true);

		return appraisalMasterPersistence.update(appraisalMaster);
	}
	...
	public AppraisalMaster createAppraisalMaster(long appraisalId) {
		return appraisalMasterPersistence.create(appraisalId);
	}
	...
	@Override
	public AppraisalMaster deleteAppraisalMaster(long appraisalId)
		throws PortalException {
		return appraisalMasterPersistence.remove(appraisalId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AppraisalMaster deleteAppraisalMaster(
		AppraisalMaster appraisalMaster) {
		return appraisalMasterPersistence.remove(appraisalMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AppraisalMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return appraisalMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return appraisalMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AppraisalMaster fetchAppraisalMaster(long appraisalId) {
		return appraisalMasterPersistence.fetchByPrimaryKey(appraisalId);
	}
	 ...
	 */
	@Override
	public AppraisalMaster getAppraisalMaster(long appraisalId)
		throws PortalException {
		return appraisalMasterPersistence.findByPrimaryKey(appraisalId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(appraisalMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AppraisalMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("appraisalId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(appraisalMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AppraisalMaster.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("appraisalId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return appraisalMasterLocalService.deleteAppraisalMaster((AppraisalMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return appraisalMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AppraisalMaster> getAppraisalMasters(int start, int end) {
		return appraisalMasterPersistence.findAll(start, end);
	}
	...
	public int getAppraisalMastersCount() {
		return appraisalMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AppraisalMaster updateAppraisalMaster(
		AppraisalMaster appraisalMaster) {
		return appraisalMasterPersistence.update(appraisalMaster);
	}
	 ...
	 */
	public AppraisalMasterLocalService getAppraisalMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.AppraisalMaster",
			appraisalMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.AppraisalMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = appraisalMasterPersistence.getDataSource();
	...
	@BeanReference(type = AppraisalMasterLocalService.class)
	protected AppraisalMasterLocalService appraisalMasterLocalService;
