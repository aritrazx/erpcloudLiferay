...
/**
 * Provides the base implementation for the recruitment process local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.RecruitmentProcessLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class RecruitmentProcessLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RecruitmentProcessLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.RecruitmentProcessLocalServiceUtil} to access the recruitment process local service.
	 */
	...
	@Override
	public RecruitmentProcess addRecruitmentProcess(
		RecruitmentProcess recruitmentProcess) {
		recruitmentProcess.setNew(true);

		return recruitmentProcessPersistence.update(recruitmentProcess);
	}
	...
	public RecruitmentProcess createRecruitmentProcess(
		...
		return recruitmentProcessPersistence.create(recruitmentProcessId);
	}
	...
	@Override
	public RecruitmentProcess deleteRecruitmentProcess(
		long recruitmentProcessId) throws PortalException {
		return recruitmentProcessPersistence.remove(recruitmentProcessId);
	}
	...
	public RecruitmentProcess deleteRecruitmentProcess(
		RecruitmentProcess recruitmentProcess) {
		return recruitmentProcessPersistence.remove(recruitmentProcess);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RecruitmentProcess.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return recruitmentProcessPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return recruitmentProcessPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RecruitmentProcess fetchRecruitmentProcess(long recruitmentProcessId) {
		return recruitmentProcessPersistence.fetchByPrimaryKey(recruitmentProcessId);
	}
	 ...
	 */
	@Override
	public RecruitmentProcess getRecruitmentProcess(long recruitmentProcessId)
		throws PortalException {
		return recruitmentProcessPersistence.findByPrimaryKey(recruitmentProcessId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(recruitmentProcessLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RecruitmentProcess.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("recruitmentProcessId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(recruitmentProcessLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RecruitmentProcess.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return recruitmentProcessLocalService.deleteRecruitmentProcess((RecruitmentProcess)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return recruitmentProcessPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RecruitmentProcess> getRecruitmentProcesses(int start, int end) {
		return recruitmentProcessPersistence.findAll(start, end);
	}
	...
	public int getRecruitmentProcessesCount() {
		return recruitmentProcessPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RecruitmentProcess updateRecruitmentProcess(
		RecruitmentProcess recruitmentProcess) {
		return recruitmentProcessPersistence.update(recruitmentProcess);
	}
	 ...
	 */
	public RecruitmentProcessLocalService getRecruitmentProcessLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.RecruitmentProcess",
			recruitmentProcessLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.RecruitmentProcess");
	}
	...
	public String getOSGiServiceIdentifier() {
		return RecruitmentProcessLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = recruitmentProcessPersistence.getDataSource();
	...
	@BeanReference(type = RecruitmentProcessLocalService.class)
	protected RecruitmentProcessLocalService recruitmentProcessLocalService;
