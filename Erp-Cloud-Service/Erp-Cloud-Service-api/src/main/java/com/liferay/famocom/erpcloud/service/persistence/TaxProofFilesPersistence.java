...
/**
 * The persistence interface for the tax proof files service.
 *
 * <p>
 ...
 * @see TaxProofFilesUtil
 * @generated
 */
@ProviderType
public interface TaxProofFilesPersistence extends BasePersistence<TaxProofFiles> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TaxProofFilesUtil} to access the tax proof files persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<TaxProofFiles> taxProofFileses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, TaxProofFiles> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<TaxProofFiles> findAll();
	...
	*/
	public java.util.List<TaxProofFiles> findAll(int start, int end);
	...
	*/
	public java.util.List<TaxProofFiles> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TaxProofFiles> orderByComparator);
