...
<%
	...
	long projectId = appraisalProjectMaster.getProjectId();
		...
		<div class="col-md-6 col-sm-6 col-xs-12 margintop10 paddingright0">
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<div class="form-group">
					<input id="_<%=portletId%>_startdate" 
				...
				<div class="panel-body">
					<div class="col-lg-12 col-sm-12 col-xs-12 margintop10 paddingleft0">
						...
						<!-- <div class="col-lg-6 col-sm-12 col-xs-12 margintop10 paddingleft0">
							<h4>
								<strong>Goal Description:</strong>&nbsp;Addresses the level of
								accuracy and proficiency with which the employee completes
								assigned work.
							</h4>
						</div> -->
							...
							<tbody id="custom-table">
								...
								<tr>
									...
									<%-- <td class="text-left "><select
										...
										class="fs_input custom-full" disabled=""><option
												value="0">Select Rating</option> '
											<%
										if (Validator.isNotNull(ratingMasters) && !ratingMasters.isEmpty()) {
															for (RatingMaster ratingMaster : ratingMasters) {
									%>
											<option value="<%=ratingMaster.getRatingId()%>"><%=ratingMaster.getRatingNum()%>-<%=ratingMaster.getRatingKey()%></option>
											<%
												}
																}
											%>
						...
						<div class="col-lg-6 col-sm-12 col-xs-12 margintop10 paddingleft0">
							<div class="form-group">
								<p>Employee's Comments<span style="color: red">*</span>:</p>
								<textarea id="_<%=portletId%>_commentEmp"
						...
						<div class="col-lg-6 col-sm-12 col-xs-12 margintop10 paddingleft0">
							<div class="form-group">
								<p>Overall Goal Rating by Employee<span style="color: red">*</span>:</p>
								<select id="_<%=portletId%>_goalEmpOverallRat"
						...
						<%-- <div class="col-lg-6 col-sm-12 col-xs-12 margintop10 paddingleft0"
							...
							<div class="form-group">
								...
								<textarea id="_<%=portletId%>_commentMan"
							...
							<div class="form-group">
								<p>Overall Goal Rating by Manager:</p>
								<select id="_<%=portletId%>_goalManOverallRat"
