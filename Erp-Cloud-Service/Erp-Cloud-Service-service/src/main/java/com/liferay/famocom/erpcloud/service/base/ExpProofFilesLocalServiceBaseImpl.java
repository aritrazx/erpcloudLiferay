...
import com.liferay.famocom.erpcloud.service.ExpProofFilesLocalService;
...
/**
 * Provides the base implementation for the exp proof files local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.ExpProofFilesLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.ExpProofFilesLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.ExpProofFilesLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ExpProofFilesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ExpProofFilesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.ExpProofFilesLocalServiceUtil} to access the exp proof files local service.
	 */
	...
	public ExpProofFiles addExpProofFiles(ExpProofFiles expProofFiles) {
		...
		return expProofFilesPersistence.update(expProofFiles);
	}
	...
	public ExpProofFiles createExpProofFiles(long fileId) {
		return expProofFilesPersistence.create(fileId);
	}
	...
	public ExpProofFiles deleteExpProofFiles(long fileId)
		...
		return expProofFilesPersistence.remove(fileId);
	}
	...
	public ExpProofFiles deleteExpProofFiles(ExpProofFiles expProofFiles) {
		return expProofFilesPersistence.remove(expProofFiles);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ExpProofFiles.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return expProofFilesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return expProofFilesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ExpProofFiles fetchExpProofFiles(long fileId) {
		return expProofFilesPersistence.fetchByPrimaryKey(fileId);
	}
	...
	public ExpProofFiles getExpProofFiles(long fileId)
		throws PortalException {
		return expProofFilesPersistence.findByPrimaryKey(fileId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(expProofFilesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ExpProofFiles.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(expProofFilesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ExpProofFiles.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return expProofFilesLocalService.deleteExpProofFiles((ExpProofFiles)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return expProofFilesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ExpProofFiles> getExpProofFileses(int start, int end) {
		return expProofFilesPersistence.findAll(start, end);
	}
	...
	public int getExpProofFilesesCount() {
		return expProofFilesPersistence.countAll();
	}
	 ...
	 */
	public ExpProofFilesLocalService getExpProofFilesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.ExpProofFiles",
			expProofFilesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.ExpProofFiles");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ExpProofFilesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = expProofFilesPersistence.getDataSource();
	...
	@BeanReference(type = ExpProofFilesLocalService.class)
	protected ExpProofFilesLocalService expProofFilesLocalService;
