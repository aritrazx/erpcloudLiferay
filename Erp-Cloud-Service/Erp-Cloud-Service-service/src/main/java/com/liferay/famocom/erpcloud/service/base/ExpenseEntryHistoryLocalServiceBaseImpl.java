...
import com.liferay.famocom.erpcloud.service.ExpenseEntryHistoryLocalService;
...
/**
 * Provides the base implementation for the expense entry history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.ExpenseEntryHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class ExpenseEntryHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ExpenseEntryHistoryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.ExpenseEntryHistoryLocalServiceUtil} to access the expense entry history local service.
	 */
	...
	public ExpenseEntryHistory addExpenseEntryHistory(
		...
		return expenseEntryHistoryPersistence.update(expenseEntryHistory);
	}
	...
	public ExpenseEntryHistory createExpenseEntryHistory(long expenseHistoryId) {
		return expenseEntryHistoryPersistence.create(expenseHistoryId);
	}
	...
	public ExpenseEntryHistory deleteExpenseEntryHistory(long expenseHistoryId)
		...
		return expenseEntryHistoryPersistence.remove(expenseHistoryId);
	}
	...
	public ExpenseEntryHistory deleteExpenseEntryHistory(
		ExpenseEntryHistory expenseEntryHistory) {
		return expenseEntryHistoryPersistence.remove(expenseEntryHistory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ExpenseEntryHistory.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return expenseEntryHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return expenseEntryHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ExpenseEntryHistory fetchExpenseEntryHistory(long expenseHistoryId) {
		return expenseEntryHistoryPersistence.fetchByPrimaryKey(expenseHistoryId);
	}
	...
	public ExpenseEntryHistory getExpenseEntryHistory(long expenseHistoryId)
		throws PortalException {
		return expenseEntryHistoryPersistence.findByPrimaryKey(expenseHistoryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(expenseEntryHistoryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ExpenseEntryHistory.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("expenseHistoryId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(expenseEntryHistoryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ExpenseEntryHistory.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return expenseEntryHistoryLocalService.deleteExpenseEntryHistory((ExpenseEntryHistory)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return expenseEntryHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ExpenseEntryHistory> getExpenseEntryHistories(int start, int end) {
		return expenseEntryHistoryPersistence.findAll(start, end);
	}
	...
	public int getExpenseEntryHistoriesCount() {
		return expenseEntryHistoryPersistence.countAll();
	}
	 ...
	 */
	public ExpenseEntryHistoryLocalService getExpenseEntryHistoryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.ExpenseEntryHistory",
			expenseEntryHistoryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.ExpenseEntryHistory");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ExpenseEntryHistoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = expenseEntryHistoryPersistence.getDataSource();
	...
	@BeanReference(type = ExpenseEntryHistoryLocalService.class)
	protected ExpenseEntryHistoryLocalService expenseEntryHistoryLocalService;
