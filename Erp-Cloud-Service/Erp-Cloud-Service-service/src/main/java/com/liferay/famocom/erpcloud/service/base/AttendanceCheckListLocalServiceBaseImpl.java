...
import com.liferay.famocom.erpcloud.service.AttendanceCheckListLocalService;
...
/**
 * Provides the base implementation for the attendance check list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.AttendanceCheckListLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.AttendanceCheckListLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.AttendanceCheckListLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AttendanceCheckListLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AttendanceCheckListLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.AttendanceCheckListLocalServiceUtil} to access the attendance check list local service.
	 */
	...
	@Override
	public AttendanceCheckList addAttendanceCheckList(
		AttendanceCheckList attendanceCheckList) {
		attendanceCheckList.setNew(true);

		return attendanceCheckListPersistence.update(attendanceCheckList);
	}
	...
	public AttendanceCheckList createAttendanceCheckList(
		long attendanceCheckListId) {
		return attendanceCheckListPersistence.create(attendanceCheckListId);
	}
	...
	@Override
	public AttendanceCheckList deleteAttendanceCheckList(
		long attendanceCheckListId) throws PortalException {
		return attendanceCheckListPersistence.remove(attendanceCheckListId);
	}
	...
	public AttendanceCheckList deleteAttendanceCheckList(
		AttendanceCheckList attendanceCheckList) {
		return attendanceCheckListPersistence.remove(attendanceCheckList);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AttendanceCheckList.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return attendanceCheckListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return attendanceCheckListPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AttendanceCheckList fetchAttendanceCheckList(
		long attendanceCheckListId) {
		return attendanceCheckListPersistence.fetchByPrimaryKey(attendanceCheckListId);
	}
	 ...
	 */
	@Override
	public AttendanceCheckList getAttendanceCheckList(
		long attendanceCheckListId) throws PortalException {
		return attendanceCheckListPersistence.findByPrimaryKey(attendanceCheckListId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(attendanceCheckListLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AttendanceCheckList.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(attendanceCheckListLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AttendanceCheckList.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return attendanceCheckListLocalService.deleteAttendanceCheckList((AttendanceCheckList)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return attendanceCheckListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AttendanceCheckList> getAttendanceCheckLists(int start, int end) {
		return attendanceCheckListPersistence.findAll(start, end);
	}
	...
	public int getAttendanceCheckListsCount() {
		return attendanceCheckListPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AttendanceCheckList updateAttendanceCheckList(
		AttendanceCheckList attendanceCheckList) {
		return attendanceCheckListPersistence.update(attendanceCheckList);
	}
	 ...
	 */
	public AttendanceCheckListLocalService getAttendanceCheckListLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.AttendanceCheckList",
			attendanceCheckListLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.AttendanceCheckList");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttendanceCheckListLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = attendanceCheckListPersistence.getDataSource();
	...
	@BeanReference(type = AttendanceCheckListLocalService.class)
	protected AttendanceCheckListLocalService attendanceCheckListLocalService;
