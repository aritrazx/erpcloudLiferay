...
<aui:row>
	<aui:col span="12">
		<liferay-ui:header title="Create Project" backLabel="Back"
...
<aui:form name="projectMaster"
	...
	<aui:row>
		<aui:col span="4">
			...
			<aui:input id="txtFromDate_id" name="startDate" type="text"
				label="Start Date" placeholder="Start Date" readonly="readonly"
				value="<%=pm != null ? tempStartDate : formatter1.format(startDate)%>">
				<aui:validator name="required"></aui:validator>
			</aui:input>
		</aui:col>
		...
		<aui:col span="4" id="endDateShown">
			...
			<aui:input id="txtToDate_id" name="endDate" type="text"
				label="End Date" placeholder="End Date" readonly="readonly"
				value="<%=pm != null ? tempEndDate : formatter1.format(endDate)%>">
				<aui:validator name="required"></aui:validator>
			</aui:input>
		</aui:col>
	...
	<aui:row>
			...
			String tasks = StringPool.BLANK;
					if (taskList.size() != 0) {
						for (TaskMaster obj : taskList) {
							String isChecked = StringPool.BLANK;
		...
		%>
			<div class="col-md-12"> 
				<input required="required" name="<portlet:namespace/>selectTask" id="<portlet:namespace/>selectTask" class="selectTask"
					label="" <%=isChecked%> value="<%=obj != null ? obj.getTaskId() : ""%>" type="checkbox" />
				<%-- <aui:input name="selectTask" id="selectTask" cssClass="selectTask"
					label="" checked="<%=isChecked%>"
					value="<%=obj != null ? obj.getTaskId() : ""%>" type="checkbox">
					<aui:validator name="required"></aui:validator>
				</aui:input> --%>
		...
		%>
		<input name="<portlet:namespace/>taskList" id="taskList" type="hidden"
			label="" value="<%=tmm1 != null ? alreadyChecked : ""%>"></input>
