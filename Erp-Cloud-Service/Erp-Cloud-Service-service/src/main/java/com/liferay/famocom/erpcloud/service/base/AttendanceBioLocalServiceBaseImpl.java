...
import com.liferay.famocom.erpcloud.service.AttendanceBioLocalService;
...
/**
 * Provides the base implementation for the attendance bio local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.AttendanceBioLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.AttendanceBioLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.AttendanceBioLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AttendanceBioLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AttendanceBioLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.AttendanceBioLocalServiceUtil} to access the attendance bio local service.
	 */
	...
	public AttendanceBio addAttendanceBio(AttendanceBio attendanceBio) {
		...
		return attendanceBioPersistence.update(attendanceBio);
	}
	...
	public AttendanceBio createAttendanceBio(long attendanceBioId) {
		return attendanceBioPersistence.create(attendanceBioId);
	}
	...
	public AttendanceBio deleteAttendanceBio(long attendanceBioId)
		...
		return attendanceBioPersistence.remove(attendanceBioId);
	}
	...
	public AttendanceBio deleteAttendanceBio(AttendanceBio attendanceBio) {
		return attendanceBioPersistence.remove(attendanceBio);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AttendanceBio.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return attendanceBioPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return attendanceBioPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AttendanceBio fetchAttendanceBio(long attendanceBioId) {
		return attendanceBioPersistence.fetchByPrimaryKey(attendanceBioId);
	}
	...
	public AttendanceBio getAttendanceBio(long attendanceBioId)
		throws PortalException {
		return attendanceBioPersistence.findByPrimaryKey(attendanceBioId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(attendanceBioLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AttendanceBio.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("attendanceBioId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(attendanceBioLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AttendanceBio.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return attendanceBioLocalService.deleteAttendanceBio((AttendanceBio)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return attendanceBioPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AttendanceBio> getAttendanceBios(int start, int end) {
		return attendanceBioPersistence.findAll(start, end);
	}
	...
	public int getAttendanceBiosCount() {
		return attendanceBioPersistence.countAll();
	}
	 ...
	 */
	public AttendanceBioLocalService getAttendanceBioLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.AttendanceBio",
			attendanceBioLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.AttendanceBio");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttendanceBioLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = attendanceBioPersistence.getDataSource();
	...
	@BeanReference(type = AttendanceBioLocalService.class)
	protected AttendanceBioLocalService attendanceBioLocalService;
