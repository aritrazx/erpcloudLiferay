...
import com.liferay.famocom.erpcloud.service.ExpenseEntryLocalService;
...
/**
 * Provides the base implementation for the expense entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.ExpenseEntryLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class ExpenseEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ExpenseEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.ExpenseEntryLocalServiceUtil} to access the expense entry local service.
	 */
	...
	@Override
	public ExpenseEntry addExpenseEntry(ExpenseEntry expenseEntry) {
		expenseEntry.setNew(true);

		return expenseEntryPersistence.update(expenseEntry);
	}
	...
	public ExpenseEntry createExpenseEntry(long expenseId) {
		return expenseEntryPersistence.create(expenseId);
	}
	...
	@Override
	public ExpenseEntry deleteExpenseEntry(long expenseId)
		throws PortalException {
		return expenseEntryPersistence.remove(expenseId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ExpenseEntry deleteExpenseEntry(ExpenseEntry expenseEntry) {
		return expenseEntryPersistence.remove(expenseEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ExpenseEntry.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return expenseEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return expenseEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ExpenseEntry fetchExpenseEntry(long expenseId) {
		return expenseEntryPersistence.fetchByPrimaryKey(expenseId);
	}
	 ...
	 */
	@Override
	public ExpenseEntry getExpenseEntry(long expenseId)
		throws PortalException {
		return expenseEntryPersistence.findByPrimaryKey(expenseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(expenseEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ExpenseEntry.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(expenseEntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ExpenseEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return expenseEntryLocalService.deleteExpenseEntry((ExpenseEntry)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return expenseEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ExpenseEntry> getExpenseEntries(int start, int end) {
		return expenseEntryPersistence.findAll(start, end);
	}
	...
	public int getExpenseEntriesCount() {
		return expenseEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ExpenseEntry updateExpenseEntry(ExpenseEntry expenseEntry) {
		return expenseEntryPersistence.update(expenseEntry);
	}
	 ...
	 */
	public ExpenseEntryLocalService getExpenseEntryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.ExpenseEntry",
			expenseEntryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.ExpenseEntry");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ExpenseEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = expenseEntryPersistence.getDataSource();
	...
	@BeanReference(type = ExpenseEntryLocalService.class)
	protected ExpenseEntryLocalService expenseEntryLocalService;
