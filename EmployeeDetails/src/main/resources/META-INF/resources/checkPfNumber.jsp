...
<%
			...
			dynamicQuery.add(PropertyFactoryUtil.forName("pfNo").eq(value));
			...
			System.out.println("value.3....."+adhaarNumber.size());
				...
				%>
				<p style="color: red;font-size: 14px;">This Pf number is already registered.
					Please enter different Pf number!</p>
				<%
				}
			}	
