...
import com.liferay.famocom.erpcloud.service.FormSixteenLocalService;
...
/**
 * Provides the base implementation for the form sixteen local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.FormSixteenLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class FormSixteenLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FormSixteenLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.FormSixteenLocalServiceUtil} to access the form sixteen local service.
	 */
	...
	@Override
	public FormSixteen addFormSixteen(FormSixteen formSixteen) {
		formSixteen.setNew(true);

		return formSixteenPersistence.update(formSixteen);
	}
	...
	public FormSixteen createFormSixteen(long id) {
		return formSixteenPersistence.create(id);
	}
	...
	@Override
	public FormSixteen deleteFormSixteen(long id) throws PortalException {
		return formSixteenPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FormSixteen deleteFormSixteen(FormSixteen formSixteen) {
		return formSixteenPersistence.remove(formSixteen);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FormSixteen.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return formSixteenPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return formSixteenPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return formSixteenPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FormSixteen fetchFormSixteen(long id) {
		return formSixteenPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public FormSixteen getFormSixteen(long id) throws PortalException {
		return formSixteenPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(formSixteenLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FormSixteen.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(formSixteenLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FormSixteen.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return formSixteenLocalService.deleteFormSixteen((FormSixteen)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return formSixteenPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FormSixteen> getFormSixteens(int start, int end) {
		return formSixteenPersistence.findAll(start, end);
	}
	...
	public int getFormSixteensCount() {
		return formSixteenPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FormSixteen updateFormSixteen(FormSixteen formSixteen) {
		return formSixteenPersistence.update(formSixteen);
	}
	 ...
	 */
	public FormSixteenLocalService getFormSixteenLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.FormSixteen",
			formSixteenLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.FormSixteen");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FormSixteenLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = formSixteenPersistence.getDataSource();
	...
	@BeanReference(type = FormSixteenLocalService.class)
	protected FormSixteenLocalService formSixteenLocalService;
