...
@Component(immediate = true, property = {
		"resource.name=" + MyTimesheetModelPermission.RESOURCE_NAME }, service = ResourcePermissionChecker.class)

public class MyTimesheetModelPermission extends BaseResourcePermissionChecker {
