...
import com.liferay.famocom.erpcloud.service.ExpCategoryLocalService;
...
/**
 * Provides the base implementation for the exp category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.ExpCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.ExpCategoryLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.ExpCategoryLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ExpCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ExpCategoryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.ExpCategoryLocalServiceUtil} to access the exp category local service.
	 */
	...
	@Override
	public ExpCategory addExpCategory(ExpCategory expCategory) {
		expCategory.setNew(true);

		return expCategoryPersistence.update(expCategory);
	}
	...
	public ExpCategory createExpCategory(long catId) {
		return expCategoryPersistence.create(catId);
	}
	...
	@Override
	public ExpCategory deleteExpCategory(long catId) throws PortalException {
		return expCategoryPersistence.remove(catId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ExpCategory deleteExpCategory(ExpCategory expCategory) {
		return expCategoryPersistence.remove(expCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ExpCategory.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return expCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return expCategoryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return expCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ExpCategory fetchExpCategory(long catId) {
		return expCategoryPersistence.fetchByPrimaryKey(catId);
	}
	 ...
	 */
	@Override
	public ExpCategory getExpCategory(long catId) throws PortalException {
		return expCategoryPersistence.findByPrimaryKey(catId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(expCategoryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ExpCategory.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(expCategoryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ExpCategory.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return expCategoryLocalService.deleteExpCategory((ExpCategory)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return expCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ExpCategory> getExpCategories(int start, int end) {
		return expCategoryPersistence.findAll(start, end);
	}
	...
	public int getExpCategoriesCount() {
		return expCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ExpCategory updateExpCategory(ExpCategory expCategory) {
		return expCategoryPersistence.update(expCategory);
	}
	 ...
	 */
	public ExpCategoryLocalService getExpCategoryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.ExpCategory",
			expCategoryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.ExpCategory");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ExpCategoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = expCategoryPersistence.getDataSource();
	...
	@BeanReference(type = ExpCategoryLocalService.class)
	protected ExpCategoryLocalService expCategoryLocalService;
