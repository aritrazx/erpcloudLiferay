...
import com.liferay.famocom.erpcloud.service.PerformanceMasterLocalService;
...
/**
 * Provides the base implementation for the performance master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.PerformanceMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.PerformanceMasterLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.PerformanceMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class PerformanceMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PerformanceMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.PerformanceMasterLocalServiceUtil} to access the performance master local service.
	 */
	...
	@Override
	public PerformanceMaster addPerformanceMaster(
		PerformanceMaster performanceMaster) {
		performanceMaster.setNew(true);

		return performanceMasterPersistence.update(performanceMaster);
	}
	...
	public PerformanceMaster createPerformanceMaster(long performanceId) {
		return performanceMasterPersistence.create(performanceId);
	}
	...
	@Override
	public PerformanceMaster deletePerformanceMaster(long performanceId)
		throws PortalException {
		return performanceMasterPersistence.remove(performanceId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PerformanceMaster deletePerformanceMaster(
		PerformanceMaster performanceMaster) {
		return performanceMasterPersistence.remove(performanceMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PerformanceMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return performanceMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return performanceMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PerformanceMaster fetchPerformanceMaster(long performanceId) {
		return performanceMasterPersistence.fetchByPrimaryKey(performanceId);
	}
	 ...
	 */
	@Override
	public PerformanceMaster getPerformanceMaster(long performanceId)
		throws PortalException {
		return performanceMasterPersistence.findByPrimaryKey(performanceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(performanceMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PerformanceMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("performanceId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(performanceMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PerformanceMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return performanceMasterLocalService.deletePerformanceMaster((PerformanceMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return performanceMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PerformanceMaster> getPerformanceMasters(int start, int end) {
		return performanceMasterPersistence.findAll(start, end);
	}
	...
	public int getPerformanceMastersCount() {
		return performanceMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PerformanceMaster updatePerformanceMaster(
		PerformanceMaster performanceMaster) {
		return performanceMasterPersistence.update(performanceMaster);
	}
	 ...
	 */
	public PerformanceMasterLocalService getPerformanceMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.PerformanceMaster",
			performanceMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.PerformanceMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PerformanceMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = performanceMasterPersistence.getDataSource();
	...
	@BeanReference(type = PerformanceMasterLocalService.class)
	protected PerformanceMasterLocalService performanceMasterLocalService;
