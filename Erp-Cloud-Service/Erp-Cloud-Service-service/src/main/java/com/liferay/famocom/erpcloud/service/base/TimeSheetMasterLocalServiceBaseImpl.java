...
/**
 * Provides the base implementation for the time sheet master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.TimeSheetMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class TimeSheetMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TimeSheetMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.TimeSheetMasterLocalServiceUtil} to access the time sheet master local service.
	 */
	...
	public TimeSheetMaster addTimeSheetMaster(TimeSheetMaster timeSheetMaster) {
		...
		return timeSheetMasterPersistence.update(timeSheetMaster);
	}
	...
	public TimeSheetMaster createTimeSheetMaster(long timesheetParentId) {
		return timeSheetMasterPersistence.create(timesheetParentId);
	}
	...
	public TimeSheetMaster deleteTimeSheetMaster(long timesheetParentId)
		...
		return timeSheetMasterPersistence.remove(timesheetParentId);
	}
	...
	public TimeSheetMaster deleteTimeSheetMaster(
		...
		return timeSheetMasterPersistence.remove(timeSheetMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TimeSheetMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return timeSheetMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return timeSheetMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public TimeSheetMaster fetchTimeSheetMaster(long timesheetParentId) {
		return timeSheetMasterPersistence.fetchByPrimaryKey(timesheetParentId);
	}
	...
	public TimeSheetMaster getTimeSheetMaster(long timesheetParentId)
		throws PortalException {
		return timeSheetMasterPersistence.findByPrimaryKey(timesheetParentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(timeSheetMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TimeSheetMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("timesheetParentId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(timeSheetMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TimeSheetMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return timeSheetMasterLocalService.deleteTimeSheetMaster((TimeSheetMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return timeSheetMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TimeSheetMaster> getTimeSheetMasters(int start, int end) {
		return timeSheetMasterPersistence.findAll(start, end);
	}
	...
	public int getTimeSheetMastersCount() {
		return timeSheetMasterPersistence.countAll();
	}
	 ...
	 */
	public TimeSheetMasterLocalService getTimeSheetMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.TimeSheetMaster",
			timeSheetMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.TimeSheetMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TimeSheetMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = timeSheetMasterPersistence.getDataSource();
	...
	@BeanReference(type = TimeSheetMasterLocalService.class)
	protected TimeSheetMasterLocalService timeSheetMasterLocalService;
