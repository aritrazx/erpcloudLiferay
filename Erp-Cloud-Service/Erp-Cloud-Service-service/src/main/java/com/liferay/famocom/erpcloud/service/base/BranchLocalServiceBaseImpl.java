 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.BranchLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.BranchLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.BranchLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class BranchLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements BranchLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.BranchLocalServiceUtil} to access the branch local service.
	 */
	...
	public Branch createBranch(long branchId) {
		return branchPersistence.create(branchId);
	}
	...
	public Branch deleteBranch(long branchId) throws PortalException {
		return branchPersistence.remove(branchId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Branch.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return branchPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Branch fetchBranch(long branchId) {
		return branchPersistence.fetchByPrimaryKey(branchId);
	}
	...
	public Branch getBranch(long branchId) throws PortalException {
		return branchPersistence.findByPrimaryKey(branchId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("branchId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("branchId");
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.Branch",
			branchLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.Branch");
	}
