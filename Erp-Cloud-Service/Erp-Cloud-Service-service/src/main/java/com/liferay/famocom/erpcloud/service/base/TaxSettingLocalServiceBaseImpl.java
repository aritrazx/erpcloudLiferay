...
import com.liferay.famocom.erpcloud.service.TaxSettingLocalService;
...
/**
 * Provides the base implementation for the tax setting local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.TaxSettingLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.TaxSettingLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.TaxSettingLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TaxSettingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TaxSettingLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.TaxSettingLocalServiceUtil} to access the tax setting local service.
	 */
	...
	@Override
	public TaxSetting addTaxSetting(TaxSetting taxSetting) {
		taxSetting.setNew(true);

		return taxSettingPersistence.update(taxSetting);
	}
	...
	public TaxSetting createTaxSetting(long taxSettingId) {
		return taxSettingPersistence.create(taxSettingId);
	}
	...
	@Override
	public TaxSetting deleteTaxSetting(long taxSettingId)
		throws PortalException {
		return taxSettingPersistence.remove(taxSettingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TaxSetting deleteTaxSetting(TaxSetting taxSetting) {
		return taxSettingPersistence.remove(taxSetting);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TaxSetting.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return taxSettingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return taxSettingPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return taxSettingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TaxSetting fetchTaxSetting(long taxSettingId) {
		return taxSettingPersistence.fetchByPrimaryKey(taxSettingId);
	}
	 ...
	 */
	@Override
	public TaxSetting getTaxSetting(long taxSettingId)
		throws PortalException {
		return taxSettingPersistence.findByPrimaryKey(taxSettingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(taxSettingLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TaxSetting.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("taxSettingId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(taxSettingLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TaxSetting.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return taxSettingLocalService.deleteTaxSetting((TaxSetting)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return taxSettingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TaxSetting> getTaxSettings(int start, int end) {
		return taxSettingPersistence.findAll(start, end);
	}
	...
	public int getTaxSettingsCount() {
		return taxSettingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TaxSetting updateTaxSetting(TaxSetting taxSetting) {
		return taxSettingPersistence.update(taxSetting);
	}
	 ...
	 */
	public TaxSettingLocalService getTaxSettingLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.TaxSetting",
			taxSettingLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.TaxSetting");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TaxSettingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = taxSettingPersistence.getDataSource();
	...
	@BeanReference(type = TaxSettingLocalService.class)
	protected TaxSettingLocalService taxSettingLocalService;
