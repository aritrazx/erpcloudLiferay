...
import com.liferay.famocom.erpcloud.service.GoalMasterLocalService;
...
/**
 * Provides the base implementation for the goal master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.GoalMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.GoalMasterLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.GoalMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class GoalMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GoalMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.GoalMasterLocalServiceUtil} to access the goal master local service.
	 */
	...
	@Override
	public GoalMaster addGoalMaster(GoalMaster goalMaster) {
		goalMaster.setNew(true);

		return goalMasterPersistence.update(goalMaster);
	}
	...
	public GoalMaster createGoalMaster(long goalId) {
		return goalMasterPersistence.create(goalId);
	}
	...
	@Override
	public GoalMaster deleteGoalMaster(long goalId) throws PortalException {
		return goalMasterPersistence.remove(goalId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GoalMaster deleteGoalMaster(GoalMaster goalMaster) {
		return goalMasterPersistence.remove(goalMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GoalMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return goalMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return goalMasterPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return goalMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GoalMaster fetchGoalMaster(long goalId) {
		return goalMasterPersistence.fetchByPrimaryKey(goalId);
	}
	 ...
	 */
	@Override
	public GoalMaster getGoalMaster(long goalId) throws PortalException {
		return goalMasterPersistence.findByPrimaryKey(goalId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(goalMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(GoalMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("goalId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(goalMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(GoalMaster.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("goalId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return goalMasterLocalService.deleteGoalMaster((GoalMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return goalMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GoalMaster> getGoalMasters(int start, int end) {
		return goalMasterPersistence.findAll(start, end);
	}
	...
	public int getGoalMastersCount() {
		return goalMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GoalMaster updateGoalMaster(GoalMaster goalMaster) {
		return goalMasterPersistence.update(goalMaster);
	}
	 ...
	 */
	public GoalMasterLocalService getGoalMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.GoalMaster",
			goalMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.GoalMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return GoalMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = goalMasterPersistence.getDataSource();
	...
	@BeanReference(type = GoalMasterLocalService.class)
	protected GoalMasterLocalService goalMasterLocalService;
