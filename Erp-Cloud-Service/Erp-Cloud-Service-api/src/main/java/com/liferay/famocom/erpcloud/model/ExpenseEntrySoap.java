...
/**
 * This class is used by SOAP remote services, specifically {@link com.liferay.famocom.erpcloud.service.http.ExpenseEntryServiceSoap}.
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.http.ExpenseEntryServiceSoap
 * @generated
 */
@ProviderType
public class ExpenseEntrySoap implements Serializable {
	public static ExpenseEntrySoap toSoapModel(ExpenseEntry model) {
		ExpenseEntrySoap soapModel = new ExpenseEntrySoap();
	...
	public static ExpenseEntrySoap[] toSoapModels(ExpenseEntry[] models) {
		ExpenseEntrySoap[] soapModels = new ExpenseEntrySoap[models.length];
	...
	public static ExpenseEntrySoap[][] toSoapModels(ExpenseEntry[][] models) {
		ExpenseEntrySoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new ExpenseEntrySoap[models.length][models[0].length];
		}
		else {
			soapModels = new ExpenseEntrySoap[0][0];
		}
	...
	public static ExpenseEntrySoap[] toSoapModels(List<ExpenseEntry> models) {
		List<ExpenseEntrySoap> soapModels = new ArrayList<ExpenseEntrySoap>(models.size());

		for (ExpenseEntry model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new ExpenseEntrySoap[soapModels.size()]);
	}

	public ExpenseEntrySoap() {
	}
