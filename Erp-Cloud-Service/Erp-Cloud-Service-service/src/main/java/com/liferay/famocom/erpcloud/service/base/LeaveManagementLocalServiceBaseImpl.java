...
import com.liferay.famocom.erpcloud.service.LeaveManagementLocalService;
...
/**
 * Provides the base implementation for the leave management local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.LeaveManagementLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class LeaveManagementLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LeaveManagementLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.LeaveManagementLocalServiceUtil} to access the leave management local service.
	 */
	...
	public LeaveManagement addLeaveManagement(LeaveManagement leaveManagement) {
		...
		return leaveManagementPersistence.update(leaveManagement);
	}
	...
	public LeaveManagement createLeaveManagement(long leaveId) {
		return leaveManagementPersistence.create(leaveId);
	}
	...
	@Override
	public LeaveManagement deleteLeaveManagement(long leaveId)
		throws PortalException {
		return leaveManagementPersistence.remove(leaveId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveManagement deleteLeaveManagement(
		LeaveManagement leaveManagement) {
		return leaveManagementPersistence.remove(leaveManagement);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LeaveManagement.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return leaveManagementPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return leaveManagementPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LeaveManagement fetchLeaveManagement(long leaveId) {
		return leaveManagementPersistence.fetchByPrimaryKey(leaveId);
	}
	 ...
	 */
	@Override
	public LeaveManagement getLeaveManagement(long leaveId)
		throws PortalException {
		return leaveManagementPersistence.findByPrimaryKey(leaveId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(leaveManagementLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LeaveManagement.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(leaveManagementLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LeaveManagement.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return leaveManagementLocalService.deleteLeaveManagement((LeaveManagement)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return leaveManagementPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveManagement> getLeaveManagements(int start, int end) {
		return leaveManagementPersistence.findAll(start, end);
	}
	...
	public int getLeaveManagementsCount() {
		return leaveManagementPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveManagement updateLeaveManagement(
		LeaveManagement leaveManagement) {
		return leaveManagementPersistence.update(leaveManagement);
	}
	 ...
	 */
	public LeaveManagementLocalService getLeaveManagementLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.LeaveManagement",
			leaveManagementLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.LeaveManagement");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveManagementLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = leaveManagementPersistence.getDataSource();
	...
	@BeanReference(type = LeaveManagementLocalService.class)
	protected LeaveManagementLocalService leaveManagementLocalService;
