...
/**
 * Provides the local service interface for AddTeamMember. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see AddTeamMemberLocalServiceUtil
...
public interface AddTeamMemberLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AddTeamMemberLocalServiceUtil} to access the add team member local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.AddTeamMemberLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<AddTeamMember> findBygetProjectId(long employeeId,
		long companyId) throws SystemException, NoSuchRecruitProcessException;

	public AddTeamMember findByGetProjectManager(long employeeId, long projectId);

	public AddTeamMember findByGetProjectManager(long projectId,
