...
import com.liferay.famocom.erpcloud.service.AppraisalProjectMasterLocalService;
...
/**
 * Provides the base implementation for the appraisal project master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.AppraisalProjectMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class AppraisalProjectMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AppraisalProjectMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.AppraisalProjectMasterLocalServiceUtil} to access the appraisal project master local service.
	 */
	...
	@Override
	public AppraisalProjectMaster addAppraisalProjectMaster(
		AppraisalProjectMaster appraisalProjectMaster) {
		appraisalProjectMaster.setNew(true);

		return appraisalProjectMasterPersistence.update(appraisalProjectMaster);
	}
	...
	public AppraisalProjectMaster createAppraisalProjectMaster(
		long appraisalProjectId) {
		return appraisalProjectMasterPersistence.create(appraisalProjectId);
	}
	...
	@Override
	public AppraisalProjectMaster deleteAppraisalProjectMaster(
		long appraisalProjectId) throws PortalException {
		return appraisalProjectMasterPersistence.remove(appraisalProjectId);
	}
	...
	public AppraisalProjectMaster deleteAppraisalProjectMaster(
		AppraisalProjectMaster appraisalProjectMaster) {
		return appraisalProjectMasterPersistence.remove(appraisalProjectMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AppraisalProjectMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return appraisalProjectMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return appraisalProjectMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AppraisalProjectMaster fetchAppraisalProjectMaster(
		long appraisalProjectId) {
		return appraisalProjectMasterPersistence.fetchByPrimaryKey(appraisalProjectId);
	}
	 ...
	 */
	@Override
	public AppraisalProjectMaster getAppraisalProjectMaster(
		long appraisalProjectId) throws PortalException {
		return appraisalProjectMasterPersistence.findByPrimaryKey(appraisalProjectId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(appraisalProjectMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AppraisalProjectMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("appraisalProjectId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(appraisalProjectMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AppraisalProjectMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return appraisalProjectMasterLocalService.deleteAppraisalProjectMaster((AppraisalProjectMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return appraisalProjectMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AppraisalProjectMaster> getAppraisalProjectMasters(int start,
		int end) {
		return appraisalProjectMasterPersistence.findAll(start, end);
	}
	...
	public int getAppraisalProjectMastersCount() {
		return appraisalProjectMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AppraisalProjectMaster updateAppraisalProjectMaster(
		AppraisalProjectMaster appraisalProjectMaster) {
		return appraisalProjectMasterPersistence.update(appraisalProjectMaster);
	}
	 ...
	 */
	public AppraisalProjectMasterLocalService getAppraisalProjectMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.AppraisalProjectMaster",
			appraisalProjectMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.AppraisalProjectMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AppraisalProjectMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = appraisalProjectMasterPersistence.getDataSource();
	...
	@BeanReference(type = AppraisalProjectMasterLocalService.class)
	protected AppraisalProjectMasterLocalService appraisalProjectMasterLocalService;
