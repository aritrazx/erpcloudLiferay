...
/**
 * Provides the local service interface for FormSixteenErrorFile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see FormSixteenErrorFileLocalServiceUtil
...
public interface FormSixteenErrorFileLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FormSixteenErrorFileLocalServiceUtil} to access the form sixteen error file local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.FormSixteenErrorFileLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
