...
/**
 * Provides the local service interface for RecruitmentProcess. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see RecruitmentProcessLocalServiceUtil
...
public interface RecruitmentProcessLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RecruitmentProcessLocalServiceUtil} to access the recruitment process local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.RecruitmentProcessLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RecruitmentProcess> getRecruitmentProcessesBystatus(
	...
	*/
	...
	public RecruitmentProcess updateStatus(long userId,
		long recruitmentProcessId, int status, ServiceContext serviceContext);
}