package com.liferay.famocom.erpcloud.employeetype.util;
...
public class MyComparator extends OrderByComparator{
	...
	public int compare(Object obj1, Object obj2) {
		...
		Object value2 = null;
		try {
			if ("typeName".equalsIgnoreCase(sortByCol) && obj1 instanceof EmployeeType) {
				EmployeeType ts1 = (EmployeeType) obj1;
				EmployeeType ts2 = (EmployeeType) obj2;
				value1 = ts1.getTypeName();
				value2 = ts2.getTypeName();
			} else if("pfDeduct".equalsIgnoreCase(sortByCol) && obj1 instanceof EmployeeType) {
				EmployeeType ts1 = (EmployeeType) obj1;
				EmployeeType ts2 = (EmployeeType) obj2;
				value1 = ts1.getPfDeduct();
				value2 = ts2.getPfDeduct();
			} else if("addeddate".equalsIgnoreCase(sortByCol) && obj1 instanceof EmployeeType) {
				EmployeeType ts1 = (EmployeeType) obj1;
				EmployeeType ts2 = (EmployeeType) obj2;
				value1 = ts1.getAddeddate();
				value2 = ts2.getAddeddate();
			}
			else {
				try {
