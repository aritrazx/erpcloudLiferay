...
/**
 * The persistence interface for the form sixteen error file service.
 *
 * <p>
 ...
 * @see FormSixteenErrorFileUtil
 * @generated
 */
@ProviderType
public interface FormSixteenErrorFilePersistence extends BasePersistence<FormSixteenErrorFile> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FormSixteenErrorFileUtil} to access the form sixteen error file persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<FormSixteenErrorFile> formSixteenErrorFiles);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, FormSixteenErrorFile> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<FormSixteenErrorFile> findAll();
	...
	*/
	public java.util.List<FormSixteenErrorFile> findAll(int start, int end);
	...
	*/
	public java.util.List<FormSixteenErrorFile> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<FormSixteenErrorFile> orderByComparator);
