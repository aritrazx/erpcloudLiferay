...
import com.liferay.famocom.erpcloud.service.WorksSchedulesLocalService;
...
/**
 * Provides the base implementation for the works schedules local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.WorksSchedulesLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class WorksSchedulesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements WorksSchedulesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.WorksSchedulesLocalServiceUtil} to access the works schedules local service.
	 */
	...
	@Override
	public WorksSchedules addWorksSchedules(WorksSchedules worksSchedules) {
		worksSchedules.setNew(true);

		return worksSchedulesPersistence.update(worksSchedules);
	}
	...
	public WorksSchedules createWorksSchedules(long worksSchedulesId) {
		return worksSchedulesPersistence.create(worksSchedulesId);
	}
	...
	@Override
	public WorksSchedules deleteWorksSchedules(long worksSchedulesId)
		throws PortalException {
		return worksSchedulesPersistence.remove(worksSchedulesId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public WorksSchedules deleteWorksSchedules(WorksSchedules worksSchedules) {
		return worksSchedulesPersistence.remove(worksSchedules);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(WorksSchedules.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return worksSchedulesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return worksSchedulesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public WorksSchedules fetchWorksSchedules(long worksSchedulesId) {
		return worksSchedulesPersistence.fetchByPrimaryKey(worksSchedulesId);
	}
	 ...
	 */
	@Override
	public WorksSchedules getWorksSchedules(long worksSchedulesId)
		throws PortalException {
		return worksSchedulesPersistence.findByPrimaryKey(worksSchedulesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(worksSchedulesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(WorksSchedules.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("worksSchedulesId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(worksSchedulesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(WorksSchedules.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return worksSchedulesLocalService.deleteWorksSchedules((WorksSchedules)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return worksSchedulesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<WorksSchedules> getWorksScheduleses(int start, int end) {
		return worksSchedulesPersistence.findAll(start, end);
	}
	...
	public int getWorksSchedulesesCount() {
		return worksSchedulesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public WorksSchedules updateWorksSchedules(WorksSchedules worksSchedules) {
		return worksSchedulesPersistence.update(worksSchedules);
	}
	 ...
	 */
	public WorksSchedulesLocalService getWorksSchedulesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.WorksSchedules",
			worksSchedulesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.WorksSchedules");
	}
	...
	public String getOSGiServiceIdentifier() {
		return WorksSchedulesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = worksSchedulesPersistence.getDataSource();
	...
	@BeanReference(type = WorksSchedulesLocalService.class)
	protected WorksSchedulesLocalService worksSchedulesLocalService;
