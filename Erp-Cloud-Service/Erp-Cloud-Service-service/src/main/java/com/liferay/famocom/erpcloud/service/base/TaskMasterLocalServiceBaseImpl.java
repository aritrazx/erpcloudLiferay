...
import com.liferay.famocom.erpcloud.service.TaskMasterLocalService;
...
/**
 * Provides the base implementation for the task master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.TaskMasterLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.TaskMasterLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.TaskMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TaskMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TaskMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.TaskMasterLocalServiceUtil} to access the task master local service.
	 */
	...
	public TaskMaster addTaskMaster(TaskMaster taskMaster) {
		...
		return taskMasterPersistence.update(taskMaster);
	}
	...
	public TaskMaster createTaskMaster(long taskId) {
		return taskMasterPersistence.create(taskId);
	}
	...
	@Override
	public TaskMaster deleteTaskMaster(long taskId) throws PortalException {
		return taskMasterPersistence.remove(taskId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TaskMaster deleteTaskMaster(TaskMaster taskMaster) {
		return taskMasterPersistence.remove(taskMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TaskMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return taskMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return taskMasterPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return taskMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TaskMaster fetchTaskMaster(long taskId) {
		return taskMasterPersistence.fetchByPrimaryKey(taskId);
	}
	 ...
	 */
	@Override
	public TaskMaster getTaskMaster(long taskId) throws PortalException {
		return taskMasterPersistence.findByPrimaryKey(taskId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(taskMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TaskMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(taskMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TaskMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return taskMasterLocalService.deleteTaskMaster((TaskMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return taskMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TaskMaster> getTaskMasters(int start, int end) {
		return taskMasterPersistence.findAll(start, end);
	}
	...
	public int getTaskMastersCount() {
		return taskMasterPersistence.countAll();
	}
	 ...
	 */
	public TaskMasterLocalService getTaskMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.TaskMaster",
			taskMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.TaskMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TaskMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = taskMasterPersistence.getDataSource();
	...
	@BeanReference(type = TaskMasterLocalService.class)
	protected TaskMasterLocalService taskMasterLocalService;
