...
import com.liferay.famocom.erpcloud.service.ProjectRoleLocalService;
...
/**
 * Provides the base implementation for the project role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.ProjectRoleLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.ProjectRoleLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.ProjectRoleLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ProjectRoleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProjectRoleLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.ProjectRoleLocalServiceUtil} to access the project role local service.
	 */
	...
	public ProjectRole addProjectRole(ProjectRole projectRole) {
		...
		return projectRolePersistence.update(projectRole);
	}
	...
	public ProjectRole createProjectRole(long roleId) {
		return projectRolePersistence.create(roleId);
	}
	...
	@Override
	public ProjectRole deleteProjectRole(long roleId) throws PortalException {
		return projectRolePersistence.remove(roleId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProjectRole deleteProjectRole(ProjectRole projectRole) {
		return projectRolePersistence.remove(projectRole);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectRole.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectRolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return projectRolePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectRolePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProjectRole fetchProjectRole(long roleId) {
		return projectRolePersistence.fetchByPrimaryKey(roleId);
	}
	 ...
	 */
	@Override
	public ProjectRole getProjectRole(long roleId) throws PortalException {
		return projectRolePersistence.findByPrimaryKey(roleId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectRoleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProjectRole.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(projectRoleLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProjectRole.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return projectRoleLocalService.deleteProjectRole((ProjectRole)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return projectRolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProjectRole> getProjectRoles(int start, int end) {
		return projectRolePersistence.findAll(start, end);
	}
	...
	public int getProjectRolesCount() {
		return projectRolePersistence.countAll();
	}
	 ...
	 */
	public ProjectRoleLocalService getProjectRoleLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.ProjectRole",
			projectRoleLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.ProjectRole");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectRoleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectRolePersistence.getDataSource();
	...
	@BeanReference(type = ProjectRoleLocalService.class)
	protected ProjectRoleLocalService projectRoleLocalService;
