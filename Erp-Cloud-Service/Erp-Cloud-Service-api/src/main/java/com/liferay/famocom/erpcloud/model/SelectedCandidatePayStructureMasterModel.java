...
/**
 * The base model interface for the SelectedCandidatePayStructureMaster service. Represents a row in the &quot;SelectedCandidatePayStructureMaster&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.liferay.famocom.erpcloud.model.impl.SelectedCandidatePayStructureMasterModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.liferay.famocom.erpcloud.model.impl.SelectedCandidatePayStructureMasterImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public interface SelectedCandidatePayStructureMasterModel extends BaseModel<SelectedCandidatePayStructureMaster> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a selected candidate pay structure master model instance should use the {@link SelectedCandidatePayStructureMaster} interface instead.
	 */
