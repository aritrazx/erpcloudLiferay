...
import com.liferay.famocom.erpcloud.service.ResignationLocalService;
...
/**
 * Provides the base implementation for the resignation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.ResignationLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.ResignationLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.ResignationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ResignationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ResignationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.ResignationLocalServiceUtil} to access the resignation local service.
	 */
	...
	public Resignation addResignation(Resignation resignation) {
		...
		return resignationPersistence.update(resignation);
	}
	...
	public Resignation createResignation(long ResignationId) {
		return resignationPersistence.create(ResignationId);
	}
	...
	@Override
	public Resignation deleteResignation(long ResignationId)
		throws PortalException {
		return resignationPersistence.remove(ResignationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Resignation deleteResignation(Resignation resignation) {
		return resignationPersistence.remove(resignation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Resignation.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return resignationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return resignationPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return resignationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Resignation fetchResignation(long ResignationId) {
		return resignationPersistence.fetchByPrimaryKey(ResignationId);
	}
	...
	public Resignation getResignation(long ResignationId)
		throws PortalException {
		return resignationPersistence.findByPrimaryKey(ResignationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(resignationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Resignation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ResignationId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(resignationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Resignation.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return resignationLocalService.deleteResignation((Resignation)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return resignationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Resignation> getResignations(int start, int end) {
		return resignationPersistence.findAll(start, end);
	}
	...
	public int getResignationsCount() {
		return resignationPersistence.countAll();
	}
	 ...
	 */
	public ResignationLocalService getResignationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.Resignation",
			resignationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.Resignation");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ResignationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = resignationPersistence.getDataSource();
	...
	@BeanReference(type = ResignationLocalService.class)
	protected ResignationLocalService resignationLocalService;
