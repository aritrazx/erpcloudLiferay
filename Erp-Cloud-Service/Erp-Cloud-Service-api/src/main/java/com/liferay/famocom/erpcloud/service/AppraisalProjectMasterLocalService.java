...
/**
 * Provides the local service interface for AppraisalProjectMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Samaresh
 * @see AppraisalProjectMasterLocalServiceUtil
...
public interface AppraisalProjectMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AppraisalProjectMasterLocalServiceUtil} to access the appraisal project master local service. Add custom service methods to {@link com.liferay.famocom.erpcloud.service.impl.AppraisalProjectMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<AppraisalProjectMaster> findBySettingIdAndEmployeeIdApprasialIdList(
