...
import com.liferay.famocom.erpcloud.service.BillingLocalService;
...
/**
 * Provides the base implementation for the billing local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.BillingLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.BillingLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.BillingLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class BillingLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements BillingLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.BillingLocalServiceUtil} to access the billing local service.
	 */
	...
	public Billing addBilling(Billing billing) {
		...
		return billingPersistence.update(billing);
	}
	...
	public Billing createBilling(long billingId) {
		return billingPersistence.create(billingId);
	}
	...
	public Billing deleteBilling(long billingId) throws PortalException {
		return billingPersistence.remove(billingId);
	}
	...
	public Billing deleteBilling(Billing billing) {
		return billingPersistence.remove(billing);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Billing.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return billingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return billingPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return billingPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return billingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return billingPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Billing fetchBilling(long billingId) {
		return billingPersistence.fetchByPrimaryKey(billingId);
	}
	...
	public Billing getBilling(long billingId) throws PortalException {
		return billingPersistence.findByPrimaryKey(billingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(billingLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Billing.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(billingLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Billing.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return billingLocalService.deleteBilling((Billing)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return billingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Billing> getBillings(int start, int end) {
		return billingPersistence.findAll(start, end);
	}
	...
	public int getBillingsCount() {
		return billingPersistence.countAll();
	}
	 ...
	 */
	public BillingLocalService getBillingLocalService() {
	 ...
	 */
	public void setBillingLocalService(BillingLocalService billingLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.Billing",
			billingLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.Billing");
	}
	...
	public String getOSGiServiceIdentifier() {
		return BillingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = billingPersistence.getDataSource();
	...
	@BeanReference(type = BillingLocalService.class)
	protected BillingLocalService billingLocalService;
