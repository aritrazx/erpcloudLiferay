package com.liferay.famocom.erpcloud.salaryprocess.constants;

/**
 * @author FAMOCOM-AJEET
 */
public class SalaryProcessPortletKeys {

	public static final String SalaryProcess = "SalaryProcess";
