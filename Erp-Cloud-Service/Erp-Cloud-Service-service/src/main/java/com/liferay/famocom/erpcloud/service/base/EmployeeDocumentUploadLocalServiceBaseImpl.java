...
import com.liferay.famocom.erpcloud.service.EmployeeDocumentUploadLocalService;
...
/**
 * Provides the base implementation for the employee document upload local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.EmployeeDocumentUploadLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.EmployeeDocumentUploadLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.EmployeeDocumentUploadLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class EmployeeDocumentUploadLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EmployeeDocumentUploadLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.EmployeeDocumentUploadLocalServiceUtil} to access the employee document upload local service.
	 */
	...
	@Override
	public EmployeeDocumentUpload addEmployeeDocumentUpload(
		EmployeeDocumentUpload employeeDocumentUpload) {
		employeeDocumentUpload.setNew(true);

		return employeeDocumentUploadPersistence.update(employeeDocumentUpload);
	}
	...
	public EmployeeDocumentUpload createEmployeeDocumentUpload(
		long empDocumentId) {
		return employeeDocumentUploadPersistence.create(empDocumentId);
	}
	...
	@Override
	public EmployeeDocumentUpload deleteEmployeeDocumentUpload(
		long empDocumentId) throws PortalException {
		return employeeDocumentUploadPersistence.remove(empDocumentId);
	}
	...
	public EmployeeDocumentUpload deleteEmployeeDocumentUpload(
		EmployeeDocumentUpload employeeDocumentUpload) {
		return employeeDocumentUploadPersistence.remove(employeeDocumentUpload);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EmployeeDocumentUpload.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return employeeDocumentUploadPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return employeeDocumentUploadPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public EmployeeDocumentUpload fetchEmployeeDocumentUpload(
		long empDocumentId) {
		return employeeDocumentUploadPersistence.fetchByPrimaryKey(empDocumentId);
	}
	 ...
	 */
	@Override
	public EmployeeDocumentUpload getEmployeeDocumentUpload(long empDocumentId)
		throws PortalException {
		return employeeDocumentUploadPersistence.findByPrimaryKey(empDocumentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(employeeDocumentUploadLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmployeeDocumentUpload.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("empDocumentId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(employeeDocumentUploadLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EmployeeDocumentUpload.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return employeeDocumentUploadLocalService.deleteEmployeeDocumentUpload((EmployeeDocumentUpload)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return employeeDocumentUploadPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmployeeDocumentUpload> getEmployeeDocumentUploads(int start,
		int end) {
		return employeeDocumentUploadPersistence.findAll(start, end);
	}
	...
	public int getEmployeeDocumentUploadsCount() {
		return employeeDocumentUploadPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmployeeDocumentUpload updateEmployeeDocumentUpload(
		EmployeeDocumentUpload employeeDocumentUpload) {
		return employeeDocumentUploadPersistence.update(employeeDocumentUpload);
	}
	 ...
	 */
	public EmployeeDocumentUploadLocalService getEmployeeDocumentUploadLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.EmployeeDocumentUpload",
			employeeDocumentUploadLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.EmployeeDocumentUpload");
	}
	...
	public String getOSGiServiceIdentifier() {
		return EmployeeDocumentUploadLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = employeeDocumentUploadPersistence.getDataSource();
	...
	@BeanReference(type = EmployeeDocumentUploadLocalService.class)
	protected EmployeeDocumentUploadLocalService employeeDocumentUploadLocalService;
