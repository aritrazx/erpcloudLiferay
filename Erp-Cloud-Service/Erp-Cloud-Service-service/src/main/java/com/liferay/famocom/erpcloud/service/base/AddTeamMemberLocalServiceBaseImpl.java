...
/**
 * Provides the base implementation for the add team member local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.AddTeamMemberLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class AddTeamMemberLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AddTeamMemberLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.AddTeamMemberLocalServiceUtil} to access the add team member local service.
	 */
	...
	@Override
	public AddTeamMember addAddTeamMember(AddTeamMember addTeamMember) {
		addTeamMember.setNew(true);

		return addTeamMemberPersistence.update(addTeamMember);
	}
	...
	public AddTeamMember createAddTeamMember(long projectTeamsId) {
		return addTeamMemberPersistence.create(projectTeamsId);
	}
	...
	@Override
	public AddTeamMember deleteAddTeamMember(long projectTeamsId)
		throws PortalException {
		return addTeamMemberPersistence.remove(projectTeamsId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AddTeamMember deleteAddTeamMember(AddTeamMember addTeamMember) {
		return addTeamMemberPersistence.remove(addTeamMember);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AddTeamMember.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addTeamMemberPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addTeamMemberPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AddTeamMember fetchAddTeamMember(long projectTeamsId) {
		return addTeamMemberPersistence.fetchByPrimaryKey(projectTeamsId);
	}
	 ...
	 */
	@Override
	public AddTeamMember getAddTeamMember(long projectTeamsId)
		throws PortalException {
		return addTeamMemberPersistence.findByPrimaryKey(projectTeamsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(addTeamMemberLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddTeamMember.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("projectTeamsId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(addTeamMemberLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AddTeamMember.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return addTeamMemberLocalService.deleteAddTeamMember((AddTeamMember)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return addTeamMemberPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddTeamMember> getAddTeamMembers(int start, int end) {
		return addTeamMemberPersistence.findAll(start, end);
	}
	...
	public int getAddTeamMembersCount() {
		return addTeamMemberPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddTeamMember updateAddTeamMember(AddTeamMember addTeamMember) {
		return addTeamMemberPersistence.update(addTeamMember);
	}
	 ...
	 */
	public AddTeamMemberLocalService getAddTeamMemberLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.AddTeamMember",
			addTeamMemberLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.AddTeamMember");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddTeamMemberLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = addTeamMemberPersistence.getDataSource();
	...
	@BeanReference(type = AddTeamMemberLocalService.class)
	protected AddTeamMemberLocalService addTeamMemberLocalService;
