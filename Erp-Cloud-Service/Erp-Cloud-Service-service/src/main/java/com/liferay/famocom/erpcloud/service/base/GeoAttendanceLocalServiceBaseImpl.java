...
import com.liferay.famocom.erpcloud.service.GeoAttendanceLocalService;
...
/**
 * Provides the base implementation for the geo attendance local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.GeoAttendanceLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.GeoAttendanceLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.GeoAttendanceLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class GeoAttendanceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GeoAttendanceLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.GeoAttendanceLocalServiceUtil} to access the geo attendance local service.
	 */
	...
	@Override
	public GeoAttendance addGeoAttendance(GeoAttendance geoAttendance) {
		geoAttendance.setNew(true);

		return geoAttendancePersistence.update(geoAttendance);
	}
	...
	public GeoAttendance createGeoAttendance(long attendanceId) {
		return geoAttendancePersistence.create(attendanceId);
	}
	...
	@Override
	public GeoAttendance deleteGeoAttendance(long attendanceId)
		throws PortalException {
		return geoAttendancePersistence.remove(attendanceId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GeoAttendance deleteGeoAttendance(GeoAttendance geoAttendance) {
		return geoAttendancePersistence.remove(geoAttendance);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GeoAttendance.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return geoAttendancePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return geoAttendancePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GeoAttendance fetchGeoAttendance(long attendanceId) {
		return geoAttendancePersistence.fetchByPrimaryKey(attendanceId);
	}
	 ...
	 */
	@Override
	public GeoAttendance getGeoAttendance(long attendanceId)
		throws PortalException {
		return geoAttendancePersistence.findByPrimaryKey(attendanceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(geoAttendanceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(GeoAttendance.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(geoAttendanceLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(GeoAttendance.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return geoAttendanceLocalService.deleteGeoAttendance((GeoAttendance)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return geoAttendancePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GeoAttendance> getGeoAttendances(int start, int end) {
		return geoAttendancePersistence.findAll(start, end);
	}
	...
	public int getGeoAttendancesCount() {
		return geoAttendancePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GeoAttendance updateGeoAttendance(GeoAttendance geoAttendance) {
		return geoAttendancePersistence.update(geoAttendance);
	}
	 ...
	 */
	public GeoAttendanceLocalService getGeoAttendanceLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.GeoAttendance",
			geoAttendanceLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.GeoAttendance");
	}
	...
	public String getOSGiServiceIdentifier() {
		return GeoAttendanceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = geoAttendancePersistence.getDataSource();
	...
	@BeanReference(type = GeoAttendanceLocalService.class)
	protected GeoAttendanceLocalService geoAttendanceLocalService;
