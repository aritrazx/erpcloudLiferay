...
import com.liferay.famocom.erpcloud.service.TaskMasterMappingLocalService;
...
/**
 * Provides the base implementation for the task master mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.TaskMasterMappingLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.TaskMasterMappingLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.TaskMasterMappingLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TaskMasterMappingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TaskMasterMappingLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.TaskMasterMappingLocalServiceUtil} to access the task master mapping local service.
	 */
	...
	@Override
	public TaskMasterMapping addTaskMasterMapping(
		TaskMasterMapping taskMasterMapping) {
		taskMasterMapping.setNew(true);

		return taskMasterMappingPersistence.update(taskMasterMapping);
	}
	...
	public TaskMasterMapping createTaskMasterMapping(long taskMappingId) {
		return taskMasterMappingPersistence.create(taskMappingId);
	}
	...
	@Override
	public TaskMasterMapping deleteTaskMasterMapping(long taskMappingId)
		throws PortalException {
		return taskMasterMappingPersistence.remove(taskMappingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TaskMasterMapping deleteTaskMasterMapping(
		TaskMasterMapping taskMasterMapping) {
		return taskMasterMappingPersistence.remove(taskMasterMapping);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TaskMasterMapping.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return taskMasterMappingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return taskMasterMappingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TaskMasterMapping fetchTaskMasterMapping(long taskMappingId) {
		return taskMasterMappingPersistence.fetchByPrimaryKey(taskMappingId);
	}
	 ...
	 */
	@Override
	public TaskMasterMapping getTaskMasterMapping(long taskMappingId)
		throws PortalException {
		return taskMasterMappingPersistence.findByPrimaryKey(taskMappingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(taskMasterMappingLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TaskMasterMapping.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("taskMappingId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(taskMasterMappingLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TaskMasterMapping.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return taskMasterMappingLocalService.deleteTaskMasterMapping((TaskMasterMapping)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return taskMasterMappingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TaskMasterMapping> getTaskMasterMappings(int start, int end) {
		return taskMasterMappingPersistence.findAll(start, end);
	}
	...
	public int getTaskMasterMappingsCount() {
		return taskMasterMappingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TaskMasterMapping updateTaskMasterMapping(
		TaskMasterMapping taskMasterMapping) {
		return taskMasterMappingPersistence.update(taskMasterMapping);
	}
	 ...
	 */
	public TaskMasterMappingLocalService getTaskMasterMappingLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.TaskMasterMapping",
			taskMasterMappingLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.TaskMasterMapping");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TaskMasterMappingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = taskMasterMappingPersistence.getDataSource();
	...
	@BeanReference(type = TaskMasterMappingLocalService.class)
	protected TaskMasterMappingLocalService taskMasterMappingLocalService;
