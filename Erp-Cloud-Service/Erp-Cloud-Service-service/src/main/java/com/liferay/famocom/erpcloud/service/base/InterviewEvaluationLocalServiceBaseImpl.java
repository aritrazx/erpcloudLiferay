...
import com.liferay.famocom.erpcloud.service.InterviewEvaluationLocalService;
...
/**
 * Provides the base implementation for the interview evaluation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.InterviewEvaluationLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.InterviewEvaluationLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.InterviewEvaluationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class InterviewEvaluationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements InterviewEvaluationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.InterviewEvaluationLocalServiceUtil} to access the interview evaluation local service.
	 */
	...
	@Override
	public InterviewEvaluation addInterviewEvaluation(
		InterviewEvaluation interviewEvaluation) {
		interviewEvaluation.setNew(true);

		return interviewEvaluationPersistence.update(interviewEvaluation);
	}
	...
	public InterviewEvaluation createInterviewEvaluation(long evaluationId) {
		return interviewEvaluationPersistence.create(evaluationId);
	}
	...
	@Override
	public InterviewEvaluation deleteInterviewEvaluation(long evaluationId)
		throws PortalException {
		return interviewEvaluationPersistence.remove(evaluationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public InterviewEvaluation deleteInterviewEvaluation(
		InterviewEvaluation interviewEvaluation) {
		return interviewEvaluationPersistence.remove(interviewEvaluation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(InterviewEvaluation.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return interviewEvaluationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return interviewEvaluationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public InterviewEvaluation fetchInterviewEvaluation(long evaluationId) {
		return interviewEvaluationPersistence.fetchByPrimaryKey(evaluationId);
	}
	 ...
	 */
	@Override
	public InterviewEvaluation getInterviewEvaluation(long evaluationId)
		throws PortalException {
		return interviewEvaluationPersistence.findByPrimaryKey(evaluationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(interviewEvaluationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(InterviewEvaluation.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(interviewEvaluationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(InterviewEvaluation.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return interviewEvaluationLocalService.deleteInterviewEvaluation((InterviewEvaluation)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return interviewEvaluationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<InterviewEvaluation> getInterviewEvaluations(int start, int end) {
		return interviewEvaluationPersistence.findAll(start, end);
	}
	...
	public int getInterviewEvaluationsCount() {
		return interviewEvaluationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public InterviewEvaluation updateInterviewEvaluation(
		InterviewEvaluation interviewEvaluation) {
		return interviewEvaluationPersistence.update(interviewEvaluation);
	}
	 ...
	 */
	public InterviewEvaluationLocalService getInterviewEvaluationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.InterviewEvaluation",
			interviewEvaluationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.InterviewEvaluation");
	}
	...
	public String getOSGiServiceIdentifier() {
		return InterviewEvaluationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = interviewEvaluationPersistence.getDataSource();
	...
	@BeanReference(type = InterviewEvaluationLocalService.class)
	protected InterviewEvaluationLocalService interviewEvaluationLocalService;
