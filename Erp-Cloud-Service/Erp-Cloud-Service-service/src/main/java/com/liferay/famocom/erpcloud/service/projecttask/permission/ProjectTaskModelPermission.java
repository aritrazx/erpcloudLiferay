...
@Component(immediate = true, property = {
		"resource.name=" + ProjectTaskModelPermission.RESOURCE_NAME }, service = ResourcePermissionChecker.class)

public class ProjectTaskModelPermission extends BaseResourcePermissionChecker {
