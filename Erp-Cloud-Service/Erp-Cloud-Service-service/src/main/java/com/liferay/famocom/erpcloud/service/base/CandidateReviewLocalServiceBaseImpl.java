...
import com.liferay.famocom.erpcloud.service.CandidateReviewLocalService;
...
/**
 * Provides the base implementation for the candidate review local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.CandidateReviewLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 ...
 */
@ProviderType
public abstract class CandidateReviewLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CandidateReviewLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.CandidateReviewLocalServiceUtil} to access the candidate review local service.
	 */
	...
	public CandidateReview addCandidateReview(CandidateReview candidateReview) {
		...
		return candidateReviewPersistence.update(candidateReview);
	}
	...
	public CandidateReview createCandidateReview(long candidateReviewId) {
		return candidateReviewPersistence.create(candidateReviewId);
	}
	...
	public CandidateReview deleteCandidateReview(long candidateReviewId)
		...
		return candidateReviewPersistence.remove(candidateReviewId);
	}
	...
	public CandidateReview deleteCandidateReview(
		...
		return candidateReviewPersistence.remove(candidateReview);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CandidateReview.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return candidateReviewPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return candidateReviewPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CandidateReview fetchCandidateReview(long candidateReviewId) {
		return candidateReviewPersistence.fetchByPrimaryKey(candidateReviewId);
	}
	...
	public CandidateReview getCandidateReview(long candidateReviewId)
		throws PortalException {
		return candidateReviewPersistence.findByPrimaryKey(candidateReviewId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(candidateReviewLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CandidateReview.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("candidateReviewId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(candidateReviewLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CandidateReview.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return candidateReviewLocalService.deleteCandidateReview((CandidateReview)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return candidateReviewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CandidateReview> getCandidateReviews(int start, int end) {
		return candidateReviewPersistence.findAll(start, end);
	}
	...
	public int getCandidateReviewsCount() {
		return candidateReviewPersistence.countAll();
	}
	 ...
	 */
	public CandidateReviewLocalService getCandidateReviewLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.CandidateReview",
			candidateReviewLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.CandidateReview");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CandidateReviewLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = candidateReviewPersistence.getDataSource();
	...
	@BeanReference(type = CandidateReviewLocalService.class)
	protected CandidateReviewLocalService candidateReviewLocalService;
