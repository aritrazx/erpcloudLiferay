...
<%-- <aui:input type="text" name="formulla" id="formulla" label="Formula" readOnly="true" value="" > </aui:input>
...
function generateFormulla(){
	...
	if(cmponent!=""){
		...
		Liferay.Util.getOpener().selectFormula(formula,formullaText);
		//var submitHtml ='<button  type=submit class=btn btn-default onclick=Liferay.Util.getOpener().selectFormula( '+formula+') >Submit</button>';
		   	
		//$('#formulaSubmit').html(submitHtml);
