...
/**
 * This class is used by SOAP remote services, specifically {@link com.liferay.famocom.erpcloud.service.http.TaxDeclarationMonthlyServiceSoap}.
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.http.TaxDeclarationMonthlyServiceSoap
 * @generated
 */
@ProviderType
public class TaxDeclarationMonthlySoap implements Serializable {
	public static TaxDeclarationMonthlySoap toSoapModel(
		TaxDeclarationMonthly model) {
		TaxDeclarationMonthlySoap soapModel = new TaxDeclarationMonthlySoap();

		soapModel.setTaxDeclarationMonthlyId(model.getTaxDeclarationMonthlyId());
		...
		soapModel.setTotalConveyance(model.getTotalConveyance());
		soapModel.setAddedDate(model.getAddedDate());
		soapModel.setCurrentMonthTax(model.getCurrentMonthTax());
		soapModel.setSectionEExempt(model.getSectionEExempt());

		return soapModel;
	}

	public static TaxDeclarationMonthlySoap[] toSoapModels(
		TaxDeclarationMonthly[] models) {
		TaxDeclarationMonthlySoap[] soapModels = new TaxDeclarationMonthlySoap[models.length];
	...
	public static TaxDeclarationMonthlySoap[][] toSoapModels(
		TaxDeclarationMonthly[][] models) {
		TaxDeclarationMonthlySoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new TaxDeclarationMonthlySoap[models.length][models[0].length];
		}
		else {
			soapModels = new TaxDeclarationMonthlySoap[0][0];
		}
	...
	public static TaxDeclarationMonthlySoap[] toSoapModels(
		List<TaxDeclarationMonthly> models) {
		List<TaxDeclarationMonthlySoap> soapModels = new ArrayList<TaxDeclarationMonthlySoap>(models.size());

		for (TaxDeclarationMonthly model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new TaxDeclarationMonthlySoap[soapModels.size()]);
	}

	public TaxDeclarationMonthlySoap() {
	}
