...
import com.liferay.famocom.erpcloud.service.YearSettingLocalService;
...
/**
 * Provides the base implementation for the year setting local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.famocom.erpcloud.service.impl.YearSettingLocalServiceImpl}.
 * </p>
 *
 * @author Samaresh
 * @see com.liferay.famocom.erpcloud.service.impl.YearSettingLocalServiceImpl
 * @see com.liferay.famocom.erpcloud.service.YearSettingLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class YearSettingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements YearSettingLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.famocom.erpcloud.service.YearSettingLocalServiceUtil} to access the year setting local service.
	 */
	...
	@Override
	public YearSetting addYearSetting(YearSetting yearSetting) {
		yearSetting.setNew(true);

		return yearSettingPersistence.update(yearSetting);
	}
	...
	public YearSetting createYearSetting(long yearSettingId) {
		return yearSettingPersistence.create(yearSettingId);
	}
	...
	@Override
	public YearSetting deleteYearSetting(long yearSettingId)
		throws PortalException {
		return yearSettingPersistence.remove(yearSettingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public YearSetting deleteYearSetting(YearSetting yearSetting) {
		return yearSettingPersistence.remove(yearSetting);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(YearSetting.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return yearSettingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return yearSettingPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return yearSettingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public YearSetting fetchYearSetting(long yearSettingId) {
		return yearSettingPersistence.fetchByPrimaryKey(yearSettingId);
	}
	 ...
	 */
	@Override
	public YearSetting getYearSetting(long yearSettingId)
		throws PortalException {
		return yearSettingPersistence.findByPrimaryKey(yearSettingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(yearSettingLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(YearSetting.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("yearSettingId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(yearSettingLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(YearSetting.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return yearSettingLocalService.deleteYearSetting((YearSetting)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return yearSettingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<YearSetting> getYearSettings(int start, int end) {
		return yearSettingPersistence.findAll(start, end);
	}
	...
	public int getYearSettingsCount() {
		return yearSettingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public YearSetting updateYearSetting(YearSetting yearSetting) {
		return yearSettingPersistence.update(yearSetting);
	}
	 ...
	 */
	public YearSettingLocalService getYearSettingLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.famocom.erpcloud.model.YearSetting",
			yearSettingLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.famocom.erpcloud.model.YearSetting");
	}
	...
	public String getOSGiServiceIdentifier() {
		return YearSettingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = yearSettingPersistence.getDataSource();
	...
	@BeanReference(type = YearSettingLocalService.class)
	protected YearSettingLocalService yearSettingLocalService;
